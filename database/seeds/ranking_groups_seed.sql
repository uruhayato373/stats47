...
INSERT OR REPLACE INTO ranking_groups (
  ...
  ('group-fire-department-pump-car-count-per-100-thousand-people', 'safety', '消防ポンプ自動車等現有数（人口10万人当たり）', NULL, NULL, 2, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-fire-department-water-count-per-100-thousand-people', 'safety', '消防水利数（人口10万人当たり）', NULL, NULL, 3, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-fire-related-personnel-count-per-100k', 'safety', '消防関係人員数（人口10万人当たり）', NULL, NULL, 4, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-fire-department-member-count-per-100-thousand-people', 'safety', '消防吏員数（人口10万人当たり）', NULL, NULL, 5, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-fire-department-dispatch-count-per-100-thousand-people', 'safety', '消防機関出動回数（人口10万人当たり）', NULL, NULL, 6, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-fire-dispatch-for-building-fire-count-per-100k', 'safety', '火災のための消防機関出動回数（人口10万人当たり）', NULL, NULL, 7, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-building-fire-count-per-100-thousand-people', 'safety', '火災出火件数（人口10万人当たり）', NULL, NULL, 8, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-building-fire-count-per-100k', 'safety', '建物火災出火件数（人口10万人当たり）', NULL, NULL, 9, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-fire-damage-casualties-per-population', 'safety', '火災死傷者数（人口10万人当たり）', NULL, NULL, 10, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-building-fire-damage-amount-per-person', 'safety', '建物火災損害額（人口1人当たり）', NULL, NULL, 11, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-fire-damage-household-count-per-100-building-fires', 'safety', '火災り災世帯数（建物火災100件当たり）', NULL, NULL, 12, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-fire-damage-casualties-per-accident', 'safety', '火災死傷者数（建物火災100件当たり）', NULL, NULL, 13, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-building-fire-damage-amount-per-building-fire', 'safety', '建物火災損害額（建物火災1件当たり）', NULL, NULL, 14, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-grade-separated-pedestrian-crossings-per-1000-km', 'safety', '立体横断施設数（道路実延長千km当たり）', NULL, NULL, 15, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-traffic-accident-count-per-population', 'safety', '交通事故発生件数（人口10万人当たり）', NULL, NULL, 16, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-traffic-accident-count-per-1000-km', 'safety', '交通事故発生件数（道路実延長千km当たり）', NULL, NULL, 17, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-traffic-accident-casualties-per-population', 'safety', '交通事故死傷者数（人口10万人当たり）', NULL, NULL, 18, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-traffic-accident-deaths-per-100k', 'safety', '交通事故死者数（人口10万人当たり）', NULL, NULL, 19, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-traffic-accident-injuries-per-100k', 'safety', '交通事故負傷者数（人口10万人当たり）', NULL, NULL, 20, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-traffic-accident-casualties-per-100-accidents', 'safety', '交通事故死傷者数（交通事故100件当たり）', NULL, NULL, 21, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-traffic-accident-deaths-per-100-accidents', 'safety', '交通事故死者数（交通事故100件当たり）', NULL, NULL, 22, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-road-traffic-law-violation-arrest-count-per-population', 'safety', '道路交通法違反検挙件数（人口千人当たり）', NULL, NULL, 23, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-police-officer-count-per-population', 'safety', '警察官数（人口千人当たり）', NULL, NULL, 24, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-penal-code-offenses-recognized-per-1000', 'safety', '刑法犯認知件数（人口千人当たり）', NULL, NULL, 25, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-theft-offenses-recognized-per-1000', 'safety', '窃盗犯認知件数（人口千人当たり）', NULL, NULL, 26, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-criminal-arrest-rate', 'safety', '刑法犯検挙率', NULL, NULL, 27, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-theft-criminal-arrest-rate', 'safety', '窃盗犯検挙率', NULL, NULL, 28, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-juvenile-criminal-arrest-person-per-population', 'safety', '少年刑法犯検挙人員（14～19歳人口千人当たり）', NULL, NULL, 29, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-juvenile-theft-offender-arrests-per-1000-14-19', 'safety', '少年窃盗犯検挙人員（14～19歳人口千人当たり）', NULL, NULL, 30, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-criminal-recognition-count-of-serious-crime-rate', 'safety', '刑法犯認知件数に占める凶悪犯の割合', NULL, NULL, 31, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-criminal-recognition-count-of-violent-crime-rate', 'safety', '刑法犯認知件数に占める粗暴犯の割合', NULL, NULL, 32, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-criminal-recognition-count-of-theft-crime-rate', 'safety', '刑法犯認知件数に占める窃盗犯の割合', NULL, NULL, 33, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-criminal-recognition-count-of-prostitution-crime-rate', 'safety', '刑法犯認知件数に占める風俗犯の割合', NULL, NULL, 34, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-special-law-criminal-arrest-count-per-population', 'safety', '特別法犯検挙件数（人口10万人当たり）', NULL, NULL, 35, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-drug-enforcement-arrest-count-per-population', 'safety', '覚醒剤取締検挙件数（人口10万人当たり）', NULL, NULL, 36, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-disaster-damage-amount-per-person', 'safety', '災害被害額（人口1人当たり）', NULL, NULL, 37, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-accidental-deaths-per-100k', 'safety', '不慮の事故による死亡者数（人口10万人当たり）', NULL, NULL, 38, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-pollution-complaints-received-per-100k', 'safety', '公害苦情受付件数（人口10万人当たり）', NULL, NULL, 39, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-smoke-emitting-facility-count', 'safety', 'ばい煙発生施設数', NULL, NULL, 40, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-general-dust-emitting-facility-count', 'safety', '一般粉じん発生施設数', NULL, NULL, 41, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-specific-business-sites-under-water-pollution-control-act', 'safety', '水質汚濁防止法上の特定事業場数', NULL, NULL, 42, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-private-life-insurance-contracts-per-1000', 'safety', '民間生命保険保有契約件数（人口千人当たり）', NULL, NULL, 43, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-private-life-insurance-amount-per-contract', 'safety', '民間生命保険保険金額（保有契約1件当たり）', NULL, NULL, 44, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-private-life-insurance-contract-amount-per-household', 'safety', '民間生命保険保険金額（1世帯当たり）', NULL, NULL, 45, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-simple-life-insurance-contract-count-per-population', 'safety', '簡易生命保険保有契約件数（人口千人当たり）', NULL, NULL, 46, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-simple-life-insurance-contract-amount-per-contract', 'safety', '簡易生命保険保有契約保険金額（保有契約1件当たり）', NULL, NULL, 47, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-fire-insurance-new-contracts-per-1000-households', 'safety', '火災保険住宅物件・一般物件新契約件数（1年）（一般世帯千世帯当たり）', NULL, NULL, 48, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-fire-insurance-claims-received-per-1000-households', 'safety', '火災保険住宅物件・一般物件保険金受取件数（1年）（一般世帯千世帯当たり）', NULL, NULL, 49, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-fire-insurance-amount-received-per-contract', 'safety', '火災保険住宅物件・一般物件受取保険金額（1年）（保有契約1件当たり）', NULL, NULL, 50, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-fire-insurance-new-contracts-per-1000-households-alt', 'safety', '火災保険住宅物件・一般物件新契約件数（一般世帯千世帯当たり）', NULL, NULL, 51, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-fire-insurance-claims-received-per-1000-households-alt', 'safety', '火災保険住宅物件・一般物件保険金受取件数（一般世帯千世帯当たり）', NULL, NULL, 52, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-fire-insurance-amount-received-per-contract-alt', 'safety', '火災保険住宅物件・一般物件受取保険金額（保有契約1件当たり）', NULL, NULL, 53, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-auto-liability-insurance-amount-received-per-payment', 'safety', '自動車損害賠償責任保険受取保険金額（支払件数1件当たり）', NULL, NULL, 54, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-private-auto-insurance-penetration-rate-vehicle', 'safety', '任意自動車保険普及率（車両）', NULL, NULL, 55, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-voluntary-auto-insurance-penetration-personal', 'safety', '任意自動車保険普及率（対人）', NULL, NULL, 56, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-voluntary-auto-insurance-penetration-property', 'safety', '任意自動車保険普及率（対物）', NULL, NULL, 57, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ...
  ('group-nursery-utilization-rate', 'education', '保育所等利用率', NULL, NULL, 44, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-elementary-school-long-absence-ratio-over-30days-per-1000', 'education', '小学校長期欠席児童比率（年度間30日以上）（児童千人当たり）', NULL, NULL, 45, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-junior-high-school-long-absence-ratio-over-30days-per-1000', 'education', '中学校長期欠席生徒比率（年度間30日以上）（生徒千人当たり）', NULL, NULL, 46, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-elementary-school-long-absence-ratio-nonattendance-over-30days-per-1000', 'education', '不登校による小学校長期欠席児童比率（年度間30日以上）（児童千人当たり）', NULL, NULL, 47, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-junior-high-school-long-absence-ratio-nonattendance-over-30days-per-1000', 'education', '不登校による中学校長期欠席生徒比率（年度間30日以上）（生徒千人当たり）', NULL, NULL, 48, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-junior-high-school-graduates-advancement-rate', 'education', '中学校卒業者の進学率', NULL, NULL, 49, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-high-school-graduates-advancement-rate', 'education', '高等学校卒業者の進学率', NULL, NULL, 50, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-in-pref-university-entrance-ratio-by-highschool-origin', 'education', '出身高校所在地県の県内大学への入学者割合（対大学入学者数）', NULL, NULL, 51, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-final-education-elementary-junior-high-ratio', 'education', '最終学歴が小学・中学卒の者の割合', NULL, NULL, 52, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-final-education-highschool-old-junior-high-ratio', 'education', '最終学歴が高校・旧中卒の者の割合', NULL, NULL, 53, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-final-education-junior-college-technical-college-ratio', 'education', '最終学歴が短大・高専卒の者の割合', NULL, NULL, 54, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-final-education-university-graduate-school-ratio', 'education', '最終学歴が大学・大学院卒の者の割合', NULL, NULL, 55, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-kindergarten-education-cost-per-student', 'education', '幼稚園教育費（在園者1人当たり）', NULL, NULL, 56, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-elementary-school-education-cost-per-student', 'education', '小学校教育費（児童1人当たり）', NULL, NULL, 57, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-junior-high-school-education-cost-per-student', 'education', '中学校教育費（生徒1人当たり）', NULL, NULL, 58, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-high-school-education-cost-fulltime-per-student', 'education', '高等学校教育費（全日制）（生徒1人当たり）', NULL, NULL, 59, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-certified-childcare-center-education-cost-per-student', 'education', '幼保連携型認定こども園教育費（在園者1人当たり）', NULL, NULL, 60, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ...
  ('group-volunteer-activity-annual-participation-rate-10plus', 'culture', 'ボランティア活動の年間行動者率（10歳以上）', NULL, NULL, 13, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-sports-annual-participation-rate-10plus', 'culture', 'スポーツの年間行動者率（10歳以上）', NULL, NULL, 14, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-passport-issuance-count-per-thousand', 'culture', '一般旅券発行件数（人口千人当たり）', NULL, NULL, 15, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-travel-leisure-annual-participation-rate-15plus', 'culture', '旅行・行楽の年間行動者率（15歳以上）', NULL, NULL, 16, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-travel-leisure-annual-participation-rate-10plus', 'culture', '旅行・行楽の年間行動者率（10歳以上）', NULL, NULL, 17, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-overseas-travel-annual-participation-rate-15plus', 'culture', '海外旅行の年間行動者率（15歳以上）', NULL, NULL, 18, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-overseas-travel-annual-participation-rate-10plus', 'culture', '海外旅行の年間行動者率（10歳以上）', NULL, NULL, 19, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-room-occupancy-rate', 'culture', '客室稼働率', NULL, NULL, 20, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-book-magazine-retail-annual-sales-per-capita', 'culture', '書籍・雑誌小売業年間商品販売額（人口1人当たり）', NULL, NULL, 21, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ...
  ('group-turnover-rate', 'labor', '離職率', NULL, NULL, 41, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-new-employment-rate', 'labor', '新規就業率', NULL, NULL, 42, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-employment-mobility-rate', 'labor', '就業異動率', NULL, NULL, 43, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-monthly-average-actual-working-hours-male-pre2019', 'labor', '月間平均実労働時間数（男）（～2019）', NULL, NULL, 44, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-monthly-average-actual-working-hours-female-pre2019', 'labor', '月間平均実労働時間数（女）（～2019）', NULL, NULL, 45, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-monthly-average-actual-working-hours-male', 'labor', '月間平均実労働時間数（男）', NULL, NULL, 46, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-monthly-average-actual-working-hours-female', 'labor', '月間平均実労働時間数（女）', NULL, NULL, 47, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-regular-cash-salary-male-pre2019', 'labor', 'きまって支給する現金給与月額（男）（～2019）', NULL, NULL, 48, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-regular-cash-salary-female-pre2019', 'labor', 'きまって支給する現金給与月額（女）（～2019）', NULL, NULL, 49, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-regular-cash-salary-male', 'labor', 'きまって支給する現金給与月額（男）', NULL, NULL, 50, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-regular-cash-salary-female', 'labor', 'きまって支給する現金給与月額（女）', NULL, NULL, 51, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-new-graduate-starting-salary-highschool-male', 'labor', '新規学卒者初任給（高校）（男）', NULL, NULL, 52, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-new-graduate-starting-salary-highschool-female', 'labor', '新規学卒者初任給（高校）（女）', NULL, NULL, 53, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-new-graduate-starting-salary-university-male', 'labor', '新規学卒者初任給（大学）（男）', NULL, NULL, 54, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-new-graduate-starting-salary-technical-juniorcollege-female', 'labor', '新規学卒者初任給（高専・短大）（女）', NULL, NULL, 55, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-new-graduate-starting-salary-university-female', 'labor', '新規学卒者初任給（大学）（女）', NULL, NULL, 56, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-new-graduate-starting-salary-technical-juniorcollege-male', 'labor', '新規学卒者初任給（高専・短大）（男）', NULL, NULL, 57, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-new-graduate-regular-salary-highschool-male', 'labor', '新規学卒者所定内給与額（高校）（男）', NULL, NULL, 58, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-new-graduate-regular-salary-highschool-female', 'labor', '新規学卒者所定内給与額（高校）（女）', NULL, NULL, 59, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-new-graduate-regular-salary-technical-juniorcollege-male', 'labor', '新規学卒者所定内給与額（高専・短大）（男）', NULL, NULL, 60, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-new-graduate-regular-salary-technical-juniorcollege-female', 'labor', '新規学卒者所定内給与額（高専・短大）（女）', NULL, NULL, 61, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-new-graduate-regular-salary-university-male', 'labor', '新規学卒者所定内給与額（大学）（男）', NULL, NULL, 62, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-new-graduate-regular-salary-university-female', 'labor', '新規学卒者所定内給与額（大学）（女）', NULL, NULL, 63, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-female-part-time-hourly-wage-pre2019', 'labor', '女性パートタイムの給与（1時間当たり）（～2019）', NULL, NULL, 64, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-male-part-time-hourly-wage-pre2019', 'labor', '男性パートタイムの給与（1時間当たり）（～2019）', NULL, NULL, 65, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-female-part-time-hourly-wage', 'labor', '女性パートタイムの給与（1時間当たり）', NULL, NULL, 66, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-male-part-time-hourly-wage', 'labor', '男性パートタイムの給与（1時間当たり）', NULL, NULL, 67, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-employment-insurance-receipt-rate', 'labor', '雇用保険受給率', NULL, NULL, 68, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-employment-insurance-basic-benefit-average', 'labor', '雇用保険基本手当平均支給額', NULL, NULL, 69, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-employment-insurance-daily-receipt-rate', 'labor', '雇用保険（日雇）受給率', NULL, NULL, 70, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-employment-insurance-daily-basic-benefit-average', 'labor', '雇用保険（日雇）基本手当平均支給額', NULL, NULL, 71, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-workers-compensation-insurance-benefits-rate', 'labor', '労働者災害補償保険給付率', NULL, NULL, 72, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-average-payment-amount-of-workers-compensation-insurance-benefits', 'labor', '労働者災害補償保険給付平均支給額', NULL, NULL, 73, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-frequency-of-occupational-accidents', 'labor', '労働災害発生の頻度', NULL, NULL, 74, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-work-accident-severity', 'labor', '労働災害の重さの程度', NULL, NULL, 75, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-female-part-time-workers-post2019 ', 'labor', '#F03231_女性パートタイム労働者数（2019～）', NULL, NULL, 76, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ...
  ('group-education-expenditure-ratio-multi-person-households', 'economy', '教育費割合（二人以上の世帯）', NULL, NULL, 14, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-culture-recreation-expenditure-ratio-multi-person-households', 'economy', '教養娯楽費割合（二人以上の世帯）', NULL, NULL, 15, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-other-consumption-expenditure-ratio-multi-person-households', 'economy', 'その他の消費支出割合（二人以上の世帯）', NULL, NULL, 16, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-average-propensity-to-consume-of-farm-households', 'economy', '農家世帯の平均消費性向', NULL, NULL, 17, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-avg-propensity-to-consume-worker-households', 'economy', '平均消費性向（二人以上の世帯のうち勤労者世帯）', NULL, NULL, 18, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-avg-savings-rate-worker-households', 'economy', '平均貯蓄率（二人以上の世帯のうち勤労者世帯）', NULL, NULL, 19, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-net-increase-rate-deposits-worker-households', 'economy', '預貯金純増率（二人以上の世帯のうち勤労者世帯）', NULL, NULL, 20, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-net-decrease-rate-land-house-loans-worker-households', 'economy', '土地家屋借金純減率（二人以上の世帯のうち勤労者世帯）', NULL, NULL, 21, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-current-savings-balance-multi-person-households', 'economy', '貯蓄現在高（二人以上の世帯）（1世帯当たり）', NULL, NULL, 22, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-current-deposit-balance-ratio-multi-person-households', 'economy', '預貯金現在高割合（二人以上の世帯）', NULL, NULL, 23, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-current-life-insurance-balance-ratio-multi-person-households', 'economy', '生命保険現在高割合（二人以上の世帯）', NULL, NULL, 24, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-current-securities-balance-ratio-multi-person-households', 'economy', '有価証券現在高割合（二人以上の世帯）', NULL, NULL, 25, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-current-liabilities-balance-multi-person-households', 'economy', '負債現在高（二人以上の世帯）（1世帯当たり）', NULL, NULL, 26, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-housing-land-liabilities-ratio-multi-person-households', 'economy', '住宅・土地のための負債割合（二人以上の世帯）', NULL, NULL, 27, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-microwave-ownership-multi-person-households-per-1000', 'economy', '電子レンジ（電子オーブンレンジを含む）所有数量（二人以上の世帯）（千世帯当たり）', NULL, NULL, 28, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-room-aircon-ownership-multi-person-households-per-1000', 'economy', 'ルームエアコン所有数量（二人以上の世帯）（千世帯当たり）', NULL, NULL, 29, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-piano-ownership-multi-person-households-per-1000', 'economy', 'ピアノ・電子ピアノ所有数量（二人以上の世帯）（千世帯当たり）', NULL, NULL, 30, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-car-ownership-multi-person-households-per-1000', 'economy', '自動車所有数量（二人以上の世帯）（千世帯当たり）', NULL, NULL, 31, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-stereo-cd-md-radio-ownership-multi-person-households-per-1000', 'economy', 'ステレオセットまたはＣＤ・ＭＤラジオカセット所有数量（二人以上の世帯）（千世帯当たり）', NULL, NULL, 32, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-mobile-phone-ownership-multi-person-households-per-1000', 'economy', '携帯電話（ＰＨＳを含む）所有数量（二人以上の世帯）（千世帯当たり）', NULL, NULL, 33, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-pc-ownership-multi-person-households-per-1000', 'economy', 'パソコン所有数量（二人以上の世帯）（千世帯当たり）', NULL, NULL, 34, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-tablet-ownership-multi-person-households-per-1000', 'economy', 'タブレット端末所有数量（二人以上の世帯）（千世帯当たり）', NULL, NULL, 35, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-smartphone-ownership-multi-person-households-per-1000', 'economy', 'スマートフォン所有数量（二人以上の世帯）（千世帯当たり）', NULL, NULL, 36, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-cpi-change-rate-total', 'economy', '消費者物価指数対前年変化率（総合）', NULL, NULL, 37, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-cpi-change-rate-excl-owner-rent', 'economy', '消費者物価指数対前年変化率（持ち家の帰属家賃を除く総合）', NULL, NULL, 38, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-cpi-change-rate-excl-fresh-food', 'economy', '消費者物価指数対前年変化率（生鮮食品を除く総合）', NULL, NULL, 39, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-cpi-change-rate-food', 'economy', '消費者物価指数対前年変化率（食料）', NULL, NULL, 40, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-cpi-change-rate-housing', 'economy', '消費者物価指数対前年変化率（住居）', NULL, NULL, 41, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-cpi-change-rate-utilities', 'economy', '消費者物価指数対前年変化率（光熱・水道）', NULL, NULL, 42, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-cpi-change-rate-furniture', 'economy', '消費者物価指数対前年変化率（家具・家事用品）', NULL, NULL, 43, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-cpi-change-rate-clothing', 'economy', '消費者物価指数対前年変化率（被服及び履物）', NULL, NULL, 44, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-cpi-change-rate-healthcare', 'economy', '消費者物価指数対前年変化率（保健医療）', NULL, NULL, 45, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-cpi-change-rate-transport-communication', 'economy', '消費者物価指数対前年変化率（交通・通信）', NULL, NULL, 46, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-cpi-change-rate-education', 'economy', '消費者物価指数対前年変化率（教育）', NULL, NULL, 47, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-cpi-change-rate-culture-recreation', 'economy', '消費者物価指数対前年変化率（教養娯楽）', NULL, NULL, 48, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-cpi-change-rate-miscellaneous', 'economy', '消費者物価指数対前年変化率（諸雑費）', NULL, NULL, 49, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-cpi-change-rate-excl-food-energy', 'economy', '消費者物価指数対前年変化率（食料（酒類を除く）及びエネルギーを除く総合）', NULL, NULL, 50, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-cpi-change-rate-excl-fresh-food-energy', 'economy', '消費者物価指数対前年変化率（生鮮食品及びエネルギーを除く総合）', NULL, NULL, 51, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-cpi-regional-difference-index-total-tokyo100', 'economy', '消費者物価地域差指数（総合：東京都区部＝100）', NULL, NULL, 52, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-cpi-regional-difference-index-total-51cities100', 'economy', '消費者物価地域差指数（総合）（51市平均＝100）', NULL, NULL, 53, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-cpi-regional-difference-index-food-tokyo100', 'economy', '消費者物価地域差指数（食料：東京都区部＝100）', NULL, NULL, 54, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-cpi-regional-difference-index-food-51cities100', 'economy', '消費者物価地域差指数（食料）（51市平均＝100）', NULL, NULL, 55, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-standard-price-change-rate-residential', 'economy', '標準価格対前年平均変動率（住宅地）', NULL, NULL, 56, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-standard-price-change-rate-commercial', 'economy', '標準価格対前年平均変動率（商業地）', NULL, NULL, 57, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-standard-price-change-rate-industrial', 'economy', '標準価格対前年平均変動率（工業地）', NULL, NULL, 58, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-cpi-regional-difference-index-total', 'economy', '消費者物価地域差指数（総合）', NULL, NULL, 59, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-cpi-regional-difference-index-excl-rent', 'economy', '消費者物価地域差指数（家賃を除く総合）', NULL, NULL, 60, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-cpi-regional-difference-index-food', 'economy', '消費者物価地域差指数（食料）', NULL, NULL, 61, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-cpi-regional-difference-index-housing', 'economy', '消費者物価地域差指数（住居）', NULL, NULL, 62, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-cpi-regional-difference-index-utilities', 'economy', '消費者物価地域差指数（光熱・水道）', NULL, NULL, 63, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-cpi-regional-difference-index-furniture', 'economy', '消費者物価地域差指数（家具・家事用品）', NULL, NULL, 64, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-cpi-regional-difference-index-clothing', 'economy', '消費者物価地域差指数（被服及び履物）', NULL, NULL, 65, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-cpi-regional-difference-index-healthcare', 'economy', '消費者物価地域差指数（保健医療）', NULL, NULL, 66, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-cpi-regional-difference-index-transport-communication', 'economy', '消費者物価地域差指数（交通・通信）', NULL, NULL, 67, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-cpi-regional-difference-index-education', 'economy', '消費者物価地域差指数（教育）', NULL, NULL, 68, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-cpi-regional-difference-index-culture-recreation', 'economy', '消費者物価地域差指数（教養娯楽）', NULL, NULL, 69, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-cpi-regional-difference-index-miscellaneous', 'economy', '消費者物価地域差指数（諸雑費）', NULL, NULL, 70, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-financial-assets-balance-multi-person-households', 'economy', '金融資産残高（貯蓄現在高）（二人以上の世帯）（1世帯当たり）', NULL, NULL, 71, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-deposit-balance-ratio-multi-person-households', 'economy', '預貯金現在高割合（二人以上の世帯）', NULL, NULL, 72, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-life-insurance-balance-ratio-multi-person-households', 'economy', '生命保険現在高割合（二人以上の世帯）', NULL, NULL, 73, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-securities-balance-ratio-multi-person-households', 'economy', '有価証券現在高割合（二人以上の世帯）', NULL, NULL, 74, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-liabilities-balance-multi-person-households', 'economy', '負債現在高（二人以上の世帯）（1世帯当たり）', NULL, NULL, 75, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-housing-land-liabilities-ratio-multi-person-households', 'economy', '住宅・土地のための負債割合（二人以上の世帯）', NULL, NULL, 76, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-annual-income-per-household', 'economy', '年間収入（1世帯当たり）', NULL, NULL, 77, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-household-head-annual-income-per-household', 'economy', '世帯主収入（年間収入）（1世帯当たり）', NULL, NULL, 78, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ...
  ('group-gdp-growth-rate-pref-h17', 'economy', '県内総生産額対前年増加率（平成17年基準）', NULL, NULL, 79, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-prefectural-income-growth-rate-h17', 'economy', '県民所得対前年増加率（平成17年基準）', NULL, NULL, 80, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-gross-prefectural-income-growth-rate-nominal-h17', 'economy', '県民総所得対前年増加率（名目）（平成17年基準）', NULL, NULL, 81, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-gross-prefectural-income-growth-rate-real-h17', 'economy', '県民総所得対前年増加率（実質）（平成17年基準）', NULL, NULL, 82, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-gdp-growth-rate-pref-h23', 'economy', '県内総生産額対前年増加率（平成23年基準）', NULL, NULL, 83, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-prefectural-income-growth-rate-h23', 'economy', '県民所得対前年増加率（平成23年基準）', NULL, NULL, 84, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-gross-prefectural-income-growth-rate-nominal-h23', 'economy', '県民総所得対前年増加率（名目）（平成23年基準）', NULL, NULL, 85, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-gdp-growth-rate-pref-h27', 'economy', '県内総生産額対前年増加率（平成27年基準）', NULL, NULL, 86, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-prefectural-income-growth-rate-h27', 'economy', '県民所得対前年増加率（平成27年基準）', NULL, NULL, 87, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-gross-prefectural-income-growth-rate-nominal-h27', 'economy', '県民総所得対前年増加率（名目）（平成27年基準）', NULL, NULL, 88, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-per-capita-prefectural-income-h17', 'economy', '1人当たり県民所得（平成17年基準）', NULL, NULL, 89, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-per-capita-prefectural-income-h23', 'economy', '1人当たり県民所得（平成23年基準）', NULL, NULL, 90, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-per-capita-prefectural-income-h27', 'economy', '1人当たり県民所得（平成27年基準）', NULL, NULL, 91, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-secondary-industry-establishment-ratio-census', 'economy', '第2次産業事業所数構成比（事業所・企業統計調査結果）', NULL, NULL, 92, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-tertiary-industry-establishment-ratio-census', 'economy', '第3次産業事業所数構成比（事業所・企業統計調査結果）', NULL, NULL, 93, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-secondary-industry-establishment-ratio', 'economy', '第2次産業事業所数構成比', NULL, NULL, 94, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-tertiary-industry-establishment-ratio', 'economy', '第3次産業事業所数構成比', NULL, NULL, 95, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-establishment-ratio-1-4-employees-private', 'economy', '従業者1～4人の事業所割合（民営）', NULL, NULL, 96, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-establishment-ratio-5-9-employees-private', 'economy', '従業者5～9人の事業所割合（民営）', NULL, NULL, 97, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-establishment-ratio-10-29-employees-private', 'economy', '従業者10～29人の事業所割合（民営）', NULL, NULL, 98, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-establishment-ratio-100-299-employees-private', 'economy', '従業者100～299人の事業所割合（民営）', NULL, NULL, 99, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-establishment-ratio-300plus-employees-private', 'economy', '従業者300人以上の事業所割合（民営）', NULL, NULL, 100, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-employee-ratio-1-4-employee-establishments-private', 'economy', '従業者1～4人の事業所の従業者割合（民営）', NULL, NULL, 101, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-employee-ratio-5-9-employee-establishments-private', 'economy', '従業者5～9人の事業所の従業者割合（民営）', NULL, NULL, 102, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-employee-ratio-10-29-employee-establishments-private', 'economy', '従業者10～29人の事業所の従業者割合（民営）', NULL, NULL, 103, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-employee-ratio-100-299-employee-establishments-private', 'economy', '従業者100～299人の事業所の従業者割合（民営）', NULL, NULL, 104, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-employee-ratio-300plus-employee-establishments-private', 'economy', '従業者300人以上の事業所の従業者割合（民営）', NULL, NULL, 105, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-secondary-industry-employees-per-establishment-census', 'economy', '第2次産業従業者数（1事業所当たり）（事業所・企業統計調査結果）', NULL, NULL, 106, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-tertiary-industry-employees-per-establishment-census', 'economy', '第3次産業従業者数（1事業所当たり）（事業所・企業統計調査結果）', NULL, NULL, 107, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-secondary-industry-employees-per-establishment', 'economy', '第2次産業従業者数（1事業所当たり）', NULL, NULL, 108, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-tertiary-industry-employees-per-establishment', 'economy', '第3次産業従業者数（1事業所当たり）', NULL, NULL, 109, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-agricultural-output-per-employed-person', 'economy', '就業者1人当たり農業産出額（販売農家）', NULL, NULL, 110, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-agricultural-output-per-worker-individual-farm', 'economy', '就業者1人当たり農業産出額（個人経営体）', NULL, NULL, 111, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-cultivated-land-area-ratio', 'economy', '耕地面積比率', NULL, NULL, 112, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-land-productivity-per-ha', 'economy', '土地生産性（耕地面積1ヘクタール当たり）', NULL, NULL, 113, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-cultivated-land-area-per-household', 'economy', '耕地面積（農家1戸当たり）', NULL, NULL, 114, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-manufacturing-shipment-amount-per-employee', 'economy', '製造品出荷額等（従業者1人当たり）', NULL, NULL, 115, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-manufacturing-shipment-amount-per-establishment', 'economy', '製造品出荷額等（1事業所当たり）', NULL, NULL, 116, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-annual-sales-amount-per-employee', 'economy', '商業年間商品販売額（卸売業＋小売業）（従業者1人当たり）', NULL, NULL, 117, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-annual-sales-amount-per-establishment', 'economy', '商業年間商品販売額（卸売業＋小売業）（1事業所当たり）', NULL, NULL, 118, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-deposit-balance-per-person', 'economy', '預貯金残高（人口1人当たり）', NULL, NULL, 119, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-postal-savings-balance-per-capita', 'economy', '郵便貯金残高（人口1人当たり）', NULL, NULL, 120, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-bank-deposit-balance-per-person', 'economy', '国内銀行預金残高（人口1人当たり）', NULL, NULL, 121, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ...
  ('group-sex-production-age-population-ratio', 'population', '人口性比（15～64歳人口）', NULL, NULL, 24, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-sex-old-population-ratio', 'population', '人口性比（65歳以上人口）', NULL, NULL, 25, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-young-population-index', 'population', '年少人口指数', NULL, NULL, 26, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-old-population-index', 'population', '老年人口指数', NULL, NULL, 27, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-dependent-population-index', 'population', '従属人口指数', NULL, NULL, 28, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-aging-index', 'population', '老年化指数', NULL, NULL, 29, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-young-population-ratio', 'population', '15歳未満人口割合', NULL, NULL, 30, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-production-age-population-ratio', 'population', '15～64歳人口割合', NULL, NULL, 31, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-old-population-ratio', 'population', '65歳以上人口割合', NULL, NULL, 32, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-unmarried-ratio-male-20-24', 'population', '未婚者割合（20～24歳・男）', NULL, NULL, 33, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-unmarried-ratio-female-20-24', 'population', '未婚者割合（20～24歳・女）', NULL, NULL, 34, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-unmarried-ratio-male-25-29', 'population', '未婚者割合（25～29歳・男）', NULL, NULL, 35, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-unmarried-ratio-female-25-29', 'population', '未婚者割合（25～29歳・女）', NULL, NULL, 36, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-unmarried-ratio-male-30-34', 'population', '未婚者割合（30～34歳・男）', NULL, NULL, 37, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-unmarried-ratio-female-30-34', 'population', '未婚者割合（30～34歳・女）', NULL, NULL, 38, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-unmarried-ratio-male-35-39', 'population', '未婚者割合（35～39歳・男）', NULL, NULL, 39, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-unmarried-ratio-female-35-39', 'population', '未婚者割合（35～39歳・女）', NULL, NULL, 40, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-unmarried-ratio-male-40-44', 'population', '未婚者割合（40～44歳・男）', NULL, NULL, 41, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-unmarried-ratio-female-40-44', 'population', '未婚者割合（40～44歳・女）', NULL, NULL, 42, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-unmarried-ratio-male-45-49', 'population', '未婚者割合（45～49歳・男）', NULL, NULL, 43, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-unmarried-ratio-female-45-49', 'population', '未婚者割合（45～49歳・女）', NULL, NULL, 44, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-unmarried-ratio-15plus', 'population', '未婚者割合（15歳以上人口）', NULL, NULL, 45, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-widowed-ratio-male-60plus', 'population', '死別者割合（60歳以上・男）', NULL, NULL, 46, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-widowed-ratio-female-60plus', 'population', '死別者割合（60歳以上・女）', NULL, NULL, 47, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-divorced-ratio-male-40-49', 'population', '離別者割合（40～49歳・男）', NULL, NULL, 48, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-divorced-ratio-female-40-49', 'population', '離別者割合（40～49歳・女）', NULL, NULL, 49, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-divorced-ratio-male-50-59', 'population', '離別者割合（50～59歳・男）', NULL, NULL, 50, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-divorced-ratio-female-50-59', 'population', '離別者割合（50～59歳・女）', NULL, NULL, 51, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-population-growth-rate', 'population', '人口増減率', NULL, NULL, 52, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-natural-increase-rate', 'population', '自然増減率', NULL, NULL, 53, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-crude-birth-rate', 'population', '粗出生率（人口千人当たり）', NULL, NULL, 54, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-total-fertility-rate', 'population', '合計特殊出生率', NULL, NULL, 55, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-crude-death-rate', 'population', '粗死亡率（人口千人当たり）', NULL, NULL, 56, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-crude-death-rate-male', 'population', '粗死亡率（男）（人口千人当たり）', NULL, NULL, 57, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-crude-death-rate-female', 'population', '粗死亡率（女）（人口千人当たり）', NULL, NULL, 58, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-age-specific-death-rate-0-4-per-1000', 'population', '年齢別死亡率（0～4歳）（人口千人当たり）', NULL, NULL, 59, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-age-adjusted-mortality-rate-old', 'population', '年齢別死亡率（65歳以上）（人口千人当たり）', NULL, NULL, 60, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-age-adjusted-death-rate-male-s60-per-1000', 'population', '年齢調整死亡率（男）(昭和60年モデル人口)（人口千人当たり）', NULL, NULL, 61, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-age-adjusted-death-rate-female-s60-per-1000', 'population', '年齢調整死亡率（女）(昭和60年モデル人口)（人口千人当たり）', NULL, NULL, 62, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-age-adjusted-death-rate-male-h27-per-1000', 'population', '年齢調整死亡率（男）(平成27年モデル人口)（人口千人当たり）', NULL, NULL, 63, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-age-adjusted-death-rate-female-h27-per-1000', 'population', '年齢調整死亡率（女）(平成27年モデル人口)（人口千人当たり）', NULL, NULL, 64, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-moving-in-excess-rate-japanese', 'population', '転入超過率（日本人移動者）', NULL, NULL, 65, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-moving-in-rate-japanese', 'population', '転入率（日本人移動者）', NULL, NULL, 66, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-moving-out-rate-japanese', 'population', '転出率（日本人移動者）', NULL, NULL, 67, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-inflow-population-ratio', 'population', '流入人口比率', NULL, NULL, 68, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-outflow-population-ratio', 'population', '流出人口比率', NULL, NULL, 69, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-social-increase-rate', 'population', '社会増減率', NULL, NULL, 70, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-moving-in-excess-rate', 'population', '転入超過率', NULL, NULL, 71, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-moving-in-rate', 'population', '転入率', NULL, NULL, 72, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-moving-out-rate', 'population', '転出率', NULL, NULL, 73, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-ratio-of-general-households-to-national', 'population', '全国一般世帯に占める一般世帯割合', NULL, NULL, 74, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-average-persons-per-general-household', 'population', '一般世帯の平均人員', NULL, NULL, 75, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-general-households', 'population', '一般世帯数', NULL, NULL, 76, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-nuclear-family-households-ratio', 'population', '核家族世帯割合', NULL, NULL, 77, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-single-person-household-ratio', 'population', '単独世帯割合', NULL, NULL, 78, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-household-ratio-with-65plus', 'population', '65歳以上の世帯員のいる世帯割合', NULL, NULL, 79, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-elderly-couple-only-household-ratio', 'population', '夫65歳以上、妻60歳以上の夫婦のみの世帯の割合', NULL, NULL, 80, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-single-person-household-old-population-ratio', 'population', '65歳以上世帯員の単独世帯の割合', NULL, NULL, 81, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-marriages-per-total-population', 'population', '婚姻率（人口千人当たり）', NULL, NULL, 82, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-divorces-per-total-population', 'population', '離婚率（人口千人当たり）', NULL, NULL, 83, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-new-housing-construction-ratio', 'lifestyle', '着工新設住宅比率', NULL, NULL, 20, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-owner-occupied-housing-ratio', 'lifestyle', '持ち家比率', NULL, NULL, 21, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-rented-housing-ratio', 'lifestyle', '借家比率', NULL, NULL, 22, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-private-rented-housing-ratio', 'lifestyle', '民営借家比率', NULL, NULL, 23, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-detached-house-ratio', 'lifestyle', '一戸建住宅比率', NULL, NULL, 24, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-row-house-ratio', 'lifestyle', '長屋建住宅比率', NULL, NULL, 25, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-apartment-ratio', 'lifestyle', '共同住宅比率', NULL, NULL, 26, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-vacant-housing-ratio', 'lifestyle', '空き家比率', NULL, NULL, 27, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-new-owner-occupied-housing-ratio', 'lifestyle', '着工新設持ち家比率', NULL, NULL, 28, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-new-rented-housing-ratio', 'lifestyle', '着工新設貸家比率', NULL, NULL, 29, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-rooms-per-dwelling', 'lifestyle', '居住室数（1住宅当たり）', NULL, NULL, 30, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-rooms-per-dwelling-owner', 'lifestyle', '居住室数（1住宅当たり）（持ち家）', NULL, NULL, 31, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-rooms-per-dwelling-rented', 'lifestyle', '居住室数（1住宅当たり）（借家）', NULL, NULL, 32, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-tatami-per-dwelling-owner', 'lifestyle', '持ち家住宅の居住室の畳数（1住宅当たり）', NULL, NULL, 33, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-tatami-per-dwelling-rented', 'lifestyle', '借家住宅の居住室の畳数（1住宅当たり）', NULL, NULL, 34, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-floor-area-per-dwelling-owner', 'lifestyle', '持ち家住宅の延べ面積（1住宅当たり）', NULL, NULL, 35, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-floor-area-per-dwelling-rented', 'lifestyle', '借家住宅の延べ面積（1住宅当たり）', NULL, NULL, 36, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-site-area-per-dwelling', 'lifestyle', '住宅の敷地面積（1住宅当たり）', NULL, NULL, 37, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-floor-area-new-owner-dwelling', 'lifestyle', '着工新設持ち家住宅の床面積（1住宅当たり）', NULL, NULL, 38, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-floor-area-new-rented-dwelling', 'lifestyle', '着工新設貸家住宅の床面積（1住宅当たり）', NULL, NULL, 39, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-floor-area-new-owner-rented-dwelling', 'lifestyle', '着工新設持ち家・貸家住宅の床面積（1住宅当たり）', NULL, NULL, 40, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-site-area-per-person', 'lifestyle', '住宅の敷地面積（1人当たり）', NULL, NULL, 41, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-tatami-per-person', 'lifestyle', '居住室の畳数（1人当たり）', NULL, NULL, 42, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-floor-area-per-person', 'lifestyle', '延べ面積（1人当たり）', NULL, NULL, 43, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-tatami-per-person-owner', 'lifestyle', '持ち家住宅の畳数（1人当たり）', NULL, NULL, 44, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-tatami-per-person-rented', 'lifestyle', '借家住宅の畳数（1人当たり）', NULL, NULL, 45, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-site-area-per-person-alt', 'lifestyle', '住宅の敷地面積（1人当たり）', NULL, NULL, 46, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-flush-toilet-housing-count-per-1000', 'lifestyle', '水洗トイレのある住宅数（人口千人当たり）', NULL, NULL, 47, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-flush-toilet-housing-ratio', 'lifestyle', '水洗トイレのある住宅比率', NULL, NULL, 48, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-bathroom-housing-ratio', 'lifestyle', '浴室のある住宅比率', NULL, NULL, 49, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-bathroom-housing-count-per-1000', 'lifestyle', '浴室のある住宅数（人口千人当たり）', NULL, NULL, 50, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-household-ratio-above-minimum-housing-area', 'lifestyle', '最低居住面積水準以上世帯割合', NULL, NULL, 51, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-household-ratio-main-earner-employee-commute-90min', 'lifestyle', '家計を主に支える者が雇用者である普通世帯比率（通勤時間90分以上）（普通世帯千世帯当たり）', NULL, NULL, 52, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-main-household-ratio-main-earner-employee-commute-90min', 'lifestyle', '家計を主に支える者が雇用者である主世帯比率（通勤時間1時間30分以上）（主世帯千世帯当たり）', NULL, NULL, 53, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-public-rental-housing-rent-per-3-3m2', 'lifestyle', '公営賃貸住宅の家賃（1か月3.3m2当たり）', NULL, NULL, 54, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-private-rental-housing-rent-per-3-3m2', 'lifestyle', '民営賃貸住宅の家賃（1か月3.3m2当たり）', NULL, NULL, 55, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-housing-site-value-per-3-3m2', 'lifestyle', '住宅敷地価額（公庫貸付分、3.3m2当たり）', NULL, NULL, 56, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-planned-construction-cost-per-m2', 'lifestyle', '着工居住用建築物工事費予定額（床面積1m2当たり）', NULL, NULL, 57, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-city-gas-supply-area-household-ratio', 'lifestyle', '都市ガス供給区域内世帯比率', NULL, NULL, 58, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-city-gas-sales-volume', 'lifestyle', '都市ガス販売量', NULL, NULL, 59, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-gasoline-sales-volume', 'lifestyle', 'ガソリン販売量', NULL, NULL, 60, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-electricity-generation-capacity', 'lifestyle', '発電電力量', NULL, NULL, 61, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-power-demand-amount', 'lifestyle', '電力需要量', NULL, NULL, 62, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-water-supply-population-ratio-pre2011', 'lifestyle', '上水道給水人口比率（－2011）', NULL, NULL, 63, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-water-supply-population-ratio-2012on', 'lifestyle', '上水道給水人口比率（2012－）', NULL, NULL, 64, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-sewerage-penetration-rate-pre2011', 'lifestyle', '下水道普及率（－2011）', NULL, NULL, 65, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-sewerage-penetration-rate-2012on', 'lifestyle', '下水道普及率（2012－）', NULL, NULL, 66, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-flush-toilet-population-ratio', 'lifestyle', '水洗化人口比率', NULL, NULL, 67, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-night-soil-treatment-population-ratio-pre2011', 'lifestyle', 'し尿処理人口比率（－2011）', NULL, NULL, 68, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-night-soil-treatment-population-ratio-2012on', 'lifestyle', 'し尿処理人口比率（2012－）', NULL, NULL, 69, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-garbage-recycling-rate', 'lifestyle', 'ごみのリサイクル率', NULL, NULL, 70, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-garbage-landfill-rate', 'lifestyle', 'ごみ埋立率', NULL, NULL, 71, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-final-disposal-site-remaining-capacity', 'lifestyle', '最終処分場残余容量', NULL, NULL, 72, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-retail-store-count-per-1000', 'lifestyle', '小売店数(事業所・企業統計調査結果）（人口千人当たり）', NULL, NULL, 73, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-apparel-retail-store-count-per-1000', 'lifestyle', '織物・衣服・身の回り品小売店数(事業所・企業統計調査結果）（人口千人当たり）', NULL, NULL, 74, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-food-retail-store-count-per-1000', 'lifestyle', '飲食料品小売店数(事業所・企業統計調査結果）（人口千人当たり）', NULL, NULL, 75, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-restaurant-count-per-1000', 'lifestyle', '飲食店数(事業所・企業統計調査結果）（人口千人当たり）', NULL, NULL, 76, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-large-retail-store-count-per-100k', 'lifestyle', '大型小売店数(事業所・企業統計調査結果）（人口10万人当たり）', NULL, NULL, 77, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-department-store-count-per-100k', 'lifestyle', '百貨店数(事業所・企業統計調査結果）（人口10万人当たり）', NULL, NULL, 78, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-self-service-store-count-per-100k', 'lifestyle', 'セルフサービス事業所数（人口10万人当たり）', NULL, NULL, 79, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-convenience-store-count-per-100k', 'lifestyle', 'コンビニエンスストア数（人口10万人当たり）', NULL, NULL, 80, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-barber-beauty-salon-count-per-100k', 'lifestyle', '理容・美容所数（人口10万人当たり）', NULL, NULL, 81, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-cleaning-shop-count-per-100k', 'lifestyle', 'クリーニング所数（人口10万人当たり）', NULL, NULL, 82, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-public-bath-count-per-100k', 'lifestyle', '公衆浴場数（人口10万人当たり）', NULL, NULL, 83, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-gas-station-count-per-100km', 'lifestyle', '給油所数（道路実延長100km当たり）', NULL, NULL, 84, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-retail-store-count-per-1000-alt', 'lifestyle', '小売店数（人口千人当たり）', NULL, NULL, 85, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-apparel-retail-store-count-per-1000-alt', 'lifestyle', '織物・衣服・身の回り品小売店数（人口千人当たり）', NULL, NULL, 86, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-food-retail-store-count-per-1000-alt', 'lifestyle', '飲食料品小売店数（人口千人当たり）', NULL, NULL, 87, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-restaurant-count-per-1000-alt', 'lifestyle', '飲食店数（人口千人当たり）', NULL, NULL, 88, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-large-retail-store-count-per-100k-alt', 'lifestyle', '大型小売店数（人口10万人当たり）', NULL, NULL, 89, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-department-supermarket-count-per-100k', 'lifestyle', '百貨店、総合スーパー数（人口10万人当たり）', NULL, NULL, 90, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-post-office-count-per-100km2', 'lifestyle', '郵便局数（可住地面積100km2当たり）', NULL, NULL, 91, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-telephone-subscription-count-per-1000', 'lifestyle', '電話加入数（人口千人当たり）', NULL, NULL, 92, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-residential-telephone-subscription-count-per-1000', 'lifestyle', '住宅用電話加入数（人口千人当たり）', NULL, NULL, 93, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-public-phone-count-per-1000', 'lifestyle', '公衆電話設置台数（人口千人当たり）', NULL, NULL, 94, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-mail-acceptance-count', 'lifestyle', '郵便物引受数', NULL, NULL, 95, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-mobile-phone-contract-count-per-1000', 'lifestyle', '携帯電話契約数（人口千人当たり）', NULL, NULL, 96, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-road-length-per-km2', 'lifestyle', '道路実延長（総面積1km2当たり）', NULL, NULL, 97, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-main-road-length-per-km2', 'lifestyle', '主要道路実延長（総面積1km2当たり）', NULL, NULL, 98, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-main-road-paving-rate', 'lifestyle', '主要道路舗装率', NULL, NULL, 99, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-municipal-road-paving-rate', 'lifestyle', '市町村道舗装率', NULL, NULL, 100, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-vehicle-kilometers-traveled', 'lifestyle', '自動車走行台キロ', NULL, NULL, 101, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-average-road-traffic', 'lifestyle', '道路平均交通量', NULL, NULL, 102, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-urbanization-control-area-ratio', 'lifestyle', '市街化調整区域面積比率', NULL, NULL, 103, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-residential-area-ratio', 'lifestyle', '住居専用地域面積比率', NULL, NULL, 104, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-residential-and-mixed-area-ratio', 'lifestyle', '住居専用・住居地域面積比率', NULL, NULL, 105, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-neighborhood-commercial-area-ratio', 'lifestyle', '近隣商業地域面積比率', NULL, NULL, 106, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-commercial-and-neighborhood-commercial-area-ratio', 'lifestyle', '商業・近隣商業地域面積比率', NULL, NULL, 107, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-industrial-and-semi-industrial-area-ratio', 'lifestyle', '工業・準工業地域面積比率', NULL, NULL, 108, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-industrial-exclusive-area-ratio', 'lifestyle', '工業専用地域面積比率', NULL, NULL, 109, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-urban-park-area-per-person', 'lifestyle', '都市公園面積（人口1人当たり）', NULL, NULL, 110, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-urban-park-count-per-100km2', 'lifestyle', '都市公園数（可住地面積100km2当たり）', NULL, NULL, 111, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-block-park-count-per-100km2', 'lifestyle', '街区公園数（可住地面積100km2当たり）', NULL, NULL, 112, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-neighborhood-park-count-per-100km2', 'lifestyle', '近隣公園数（可住地面積100km2当たり）', NULL, NULL, 113, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-sports-park-count-per-100km2', 'lifestyle', '運動公園数（可住地面積100km2当たり）', NULL, NULL, 114, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ...
  ('group-perinatal-mortality-rate-per-1000-births', 'health', '周産期死亡率（出生数千当たり）', NULL, NULL, 45, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-low-birthweight-rate-per-1000-births', 'health', '2500g未満の出生率（出生数千当たり）', NULL, NULL, 46, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-long-absence-primary-school-illness-per-1000', 'health', '病気による小学校長期欠席児童比率（年度間30日以上）（児童千人当たり）', NULL, NULL, 47, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-long-absence-middle-school-illness-per-1000', 'health', '病気による中学校長期欠席生徒比率（年度間30日以上）（生徒千人当たり）', NULL, NULL, 48, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-general-hospital-count-per-100k', 'health', '一般病院数（人口10万人当たり）', NULL, NULL, 49, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-general-clinic-count-per-100k', 'health', '一般診療所数（人口10万人当たり）', NULL, NULL, 50, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-dental-clinic-count-per-100k', 'health', '歯科診療所数（人口10万人当たり）', NULL, NULL, 51, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-psychiatric-hospital-count-per-100k', 'health', '精神科病院数（人口10万人当たり）', NULL, NULL, 52, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-general-hospital-bed-count-per-100k', 'health', '一般病院病床数（人口10万人当たり）', NULL, NULL, 53, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-psychiatric-bed-count-per-100k', 'health', '精神病床数（人口10万人当たり）', NULL, NULL, 54, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-long-term-care-medical-facility-count-per-100k-65plus', 'health', '介護療養型医療施設数（65歳以上人口10万人当たり）', NULL, NULL, 55, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-physicians-in-medical-facilities-per-100k', 'health', '医療施設に従事する医師数（人口10万人当たり）', NULL, NULL, 56, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-dentists-in-medical-facilities-per-100k', 'health', '医療施設に従事する歯科医師数（人口10万人当たり）', NULL, NULL, 57, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-nurses-in-medical-facilities-per-100k', 'health', '医療施設に従事する看護師・准看護師数（人口10万人当たり）', NULL, NULL, 58, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-fulltime-physicians-general-hospital-per-100beds-report', 'health', '一般病院常勤医師数（100病床当たり）（病院報告）', NULL, NULL, 59, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-fulltime-physicians-general-hospital-per-100beds', 'health', '一般病院常勤医師数（100病床当たり）', NULL, NULL, 60, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-nurses-general-hospital-per-100beds-report', 'health', '一般病院看護師・准看護師数（100病床当たり）（病院報告）', NULL, NULL, 61, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-nurses-general-hospital-per-100beds', 'health', '一般病院看護師・准看護師数（100病床当たり）', NULL, NULL, 62, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-public-general-hospital-ratio', 'health', '公立一般病院数の割合', NULL, NULL, 63, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-public-general-hospital-bed-ratio', 'health', '公立一般病院病床数の割合', NULL, NULL, 64, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-general-hospital-count-per-100km2', 'health', '一般病院数（可住地面積100km2当たり）', NULL, NULL, 65, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-general-clinic-count-per-100km2', 'health', '一般診療所数（可住地面積100km2当たり）', NULL, NULL, 66, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-dental-clinic-count-per-100km2', 'health', '歯科診療所数（可住地面積100km2当たり）', NULL, NULL, 67, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-outpatients-per-fulltime-physician-per-day-report', 'health', '一般病院外来患者数（常勤医師1人1日当たり）（病院報告）', NULL, NULL, 68, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-inpatients-per-fulltime-physician-per-day-report', 'health', '一般病院在院患者数（常勤医師1人1日当たり）（病院報告）', NULL, NULL, 69, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-inpatients-per-nurse-per-day-report', 'health', '一般病院在院患者数（看護師・准看護師1人1日当たり）（病院報告）', NULL, NULL, 70, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-general-hospital-bed-occupancy-rate', 'health', '一般病院病床利用率', NULL, NULL, 71, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-general-hospital-avg-length-of-stay', 'health', '一般病院平均在院日数', NULL, NULL, 72, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-outpatients-per-fulltime-physician-per-day', 'health', '一般病院外来患者数（常勤医師1人1日当たり）', NULL, NULL, 73, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-inpatients-per-fulltime-physician-per-day', 'health', '一般病院在院患者数（常勤医師1人1日当たり）', NULL, NULL, 74, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-inpatients-per-nurse-per-day', 'health', '一般病院在院患者数（看護師・准看護師1人1日当たり）', NULL, NULL, 75, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-psychiatric-outpatients-per-fulltime-physician-per-day-report', 'health', '精神科病院外来患者数（常勤医師1人1日当たり）（病院報告）', NULL, NULL, 76, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-psychiatric-inpatients-per-fulltime-physician-per-day-report', 'health', '精神科病院在院患者数（常勤医師1人1日当たり）（病院報告）', NULL, NULL, 77, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-psychiatric-inpatients-per-nurse-per-day-report', 'health', '精神科病院在院患者数（看護師・准看護師1人1日当たり）（病院報告）', NULL, NULL, 78, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-psychiatric-hospital-bed-occupancy-rate', 'health', '精神科病院病床利用率', NULL, NULL, 79, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-psychiatric-hospital-avg-length-of-stay', 'health', '精神科病院平均在院日数', NULL, NULL, 80, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-psychiatric-outpatients-per-fulltime-physician-per-day', 'health', '精神科病院外来患者数（常勤医師1人1日当たり）', NULL, NULL, 81, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-psychiatric-inpatients-per-fulltime-physician-per-day', 'health', '精神科病院在院患者数（常勤医師1人1日当たり）', NULL, NULL, 82, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-psychiatric-inpatients-per-nurse-per-day', 'health', '精神科病院在院患者数（看護師・准看護師1人1日当たり）', NULL, NULL, 83, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-emergency-hospital-general-clinic-count-per-100k', 'health', '救急告示病院・一般診療所数（人口10万人当たり）', NULL, NULL, 84, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-fire-department-emergency-car-count-per-100k', 'health', '救急自動車数（人口10万人当たり）', NULL, NULL, 85, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-annual-emergency-dispatches-per-1000', 'health', '年間救急出動件数（人口千人当たり）', NULL, NULL, 86, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-public-health-nurse-count-per-100k', 'health', '保健師数（人口10万人当たり）', NULL, NULL, 87, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-health-checkup-rate-lifestyle-diseases', 'health', '生活習慣病健康診断受診率', NULL, NULL, 88, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-maternal-health-guidance-per-100-births', 'health', '妊産婦保健指導数（出産数100当たり）', NULL, NULL, 89, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-dental-checkup-guidance-persons-per-1000', 'health', '歯科健診・保健指導延人員（人口千人当たり）', NULL, NULL, 90, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-dental-checkup-persons-per-1000', 'health', '歯科健診受診延人員（人口千人当たり）', NULL, NULL, 91, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-dental-guidance-persons-per-1000', 'health', '歯科保健指導延人員（人口千人当たり）', NULL, NULL, 92, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-food-business-facility-penalties-per-1000', 'health', '食品営業施設処分件数（千施設当たり）', NULL, NULL, 93, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-pharmacy-count-per-100k', 'health', '薬局数（人口10万人当たり）', NULL, NULL, 94, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-pharmaceutical-sales-count-per-100k', 'health', '医薬品販売業数（人口10万人当たり）', NULL, NULL, 95, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-pharmacy-count-per-100km2', 'health', '薬局数（可住地面積100km2当たり）', NULL, NULL, 96, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-pharmaceutical-sales-count-per-100km2', 'health', '医薬品販売業数（可住地面積100km2当たり）', NULL, NULL, 97, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-national-health-insurance-enrollees-per-1000', 'health', '国民健康保険被保険者数（人口千人当たり）', NULL, NULL, 98, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-national-health-insurance-visit-rate-per-1000', 'health', '国民健康保険受診率（被保険者千人当たり）', NULL, NULL, 99, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-national-health-insurance-medical-expense-per-person', 'health', '国民健康保険診療費（被保険者1人当たり）', NULL, NULL, 100, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-national-medical-expense-per-person', 'health', '1人当たりの国民医療費', NULL, NULL, 101, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-japan-health-insurance-society-enrollees-per-1000', 'health', '全国保険協会管掌健康保険加入者数（人口千人当たり）', NULL, NULL, 102, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-japan-health-insurance-society-visit-rate-insured-per-1000', 'health', '全国保険協会管掌健康保険受診率（被保険者千人当たり）', NULL, NULL, 103, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-japan-health-insurance-society-visit-rate-dependents-per-1000', 'health', '全国保険協会管掌健康保険受診率（被扶養者千人当たり）', NULL, NULL, 104, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-govt-health-insurance-visit-expense-insured-per-person', 'health', '政府管掌健康保険受診金額（被保険者1人当たり）', NULL, NULL, 105, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-govt-health-insurance-visit-expense-dependents-per-person', 'health', '政府管掌健康保険受診金額（被扶養者1人当たり）', NULL, NULL, 106, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-japan-health-insurance-society-medical-expense-insured-per-person', 'health', '全国保険協会管掌健康保険医療費（被保険者1人当たり）', NULL, NULL, 107, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('group-japan-health-insurance-society-medical-expense-dependents-per-person', 'health', '全国保険協会管掌健康保険医療費（被扶養者1人当たり）', NULL, NULL, 108, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
;

...
`/nsm-experiment` および関連スキル（`/weekly-plan`, `/weekly-review`）が参照する **NSM の計測側の実装サマリ**。戦略的な定義の真実源は `docs/00_プロジェクト管理/02_収益化戦略.md`。本ファイルはそれを計測実装と繋ぐリファレンス。
...
| **判断根拠** | `docs/00_プロジェクト管理/02_収益化戦略.md` |
...
- `docs/00_プロジェクト管理/03_マーケティング戦略.md` — 成長ループ・トラフィック戦略

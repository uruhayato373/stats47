...
> 正典規約: `.Codex/rules/area-databook-standards.md` §5 (editorial 品質) / 実行 agent: `.Codex/agents/area-curator.md`
> 実証: `.Codex/rules/evidence-based-judgment.md` (出典 URL + アクセス日必須・裏取りなしで書かない)

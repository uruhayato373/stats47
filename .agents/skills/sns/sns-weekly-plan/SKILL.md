...
- 頻度上限は rules §1 quota (`X_DAILY_MAX=3` / 週 21) が SSOT。ガードは `check-x-post-budget.cjs`。
...
- **量産しない** — 頻度上限は rules §1 を厳守 (X 1 日 3・IG カルーセル 1 / 日 + リール 1 / 週)
- **TikTok は扱わない** — 撤退恒久

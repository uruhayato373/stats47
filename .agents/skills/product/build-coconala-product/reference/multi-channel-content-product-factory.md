...
> 進捗・優先順位のSSOTは
> `.claude/todo/backlog.md#MULTICHANNEL-CONTENT-PRODUCT-01`。
...
- YouTube の通常動画 pilot は商品販売チャネル再開とはみなさない。商品販売を理由に本数・自動化を増やさず、TikTok は撤退を維持する。
...
6. 未完了事項だけを `.claude/todo/backlog.md` の該当IDへ具体化する。

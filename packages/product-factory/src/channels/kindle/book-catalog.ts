...
const S1_BOOKS: readonly KindleBook[] = [
  {
    id: "K-S1-01",
    series: "S1-issues",
    title: "所得と支出の地域差 — 家計統計を比較する前に",
    subtitle: "対象世帯・年次・分母から読み直す地域の数字",
    concept:
      "県民所得、家計調査の所得・支出、貯蓄と地域財政を別の対象として読み、対象世帯・年次・分母の一致を確認する。地域の平均を個人の手取りや県民性へ置き換えず、比較の限界と確認手順を整理する。",
    author: AUTHOR,
    chapters: [
  ...
  },
  {
    ...
    concept: "家計調査の品目別支出と購入数量を区別し、調査対象世帯・地域・年を確かめながら食卓の違いを読む。生産地や県民全体の消費を直接測る統計ではないことも整理する読み物。",
    author: AUTHOR,
    chapters: [
  ...
  },
  {
    ...
    concept: "寿命、自殺に関する指標、介護職員の必要数と病院の利用指標を比較し、医療資源の数と個人の健康状態を区別して読む。掲載した化学工業の集計は医薬品・医療機器だけの生産額ではないことも整理する。",
    author: AUTHOR,
    chapters: [
  ...
  },
  {
    ...
    concept: "公費と家計の教育費、授業料、大学進学に関する指標、子育て関連の統計を比較する。支出額と教育成果、入学者数と定員、保育所等の利用率と入所希望の充足を区別して読む。",
    author: AUTHOR,
    chapters: [
      ...
      { title: "子育て関連指標の意味と限界", source: "blog", blogSlug: "childcare-friendly-prefecture-ranking" },
    ],
    priceYen: 800,
  ...
  },
  {
    ...
    concept: "財政力指数、時系列、地方税、地方債務と将来負担比率を比較し、指標ごとの分母・控除・平均期間を確認する。家計の収支とは異なる地方財政の集計として読み、単一指標から健全性を断定しない。",
    author: AUTHOR,
    chapters: [
  ...
  },
  {
    ...
    concept: "延べ宿泊者数、国籍別の宿泊記録、対象施設の範囲、採用年の違いを確かめながら観光統計を読む。宿泊人泊と旅行者の実人数、観測された宿泊先と個人の嗜好を区別する。",
    author: AUTHOR,
    chapters: [
  ...
  },
  {
    ...
    concept: "エネルギー消費、再エネ設備、電力需要、ガス・電気、給油所の指標を読む。設備容量・契約件数・供給区域・道路当たり密度を区別し、実際の送電経路や住民の移動距離を示す値とは扱わない。",
    author: AUTHOR,
    chapters: [
  ...
  },
  {
    ...
    concept: "製造業の集計、事業所規模、工業用水、商業地地価を比較する。出荷額と付加価値、従業者当たりと事業所当たり、企業と事業所、地価の金額と変動率を分けて読む。",
    author: AUTHOR,
    chapters: [
  ...
  },
  {
    ...
    concept: "犯罪の認知・検挙、労働災害、公害苦情、廃棄物、火災・地震保険料支出を、各指標の対象と分母に沿って読む。集計値から個人の被害確率や地域の安全性全般を断定しない。",
    author: AUTHOR,
    chapters: [
  ...
  },
  {
    ...
    series: "S1-issues",
    title: "文化・スポーツ・余暇の地図",
    concept: "図書館・博物館・スポーツ施設、スポーツの行動者率、映画・演劇等への支出を比較する。施設数と利用、参加と頻度、市の家計と県全体を区別して読む。",
    author: AUTHOR,
    chapters: [
  ...
  },
  {
    ...
    concept: "ICTメディアの利用、携帯契約件数、パソコン支出、テレワーク、コンビニ密度を比較する。契約件数と利用者数、支出額と保有率、有業者と雇用者の範囲を区別して読む。",
    author: AUTHOR,
    chapters: [

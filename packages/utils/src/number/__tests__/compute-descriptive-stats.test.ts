...
describe("computeDescriptiveStats", () => {
  ...
  it("should calculate correct stats for a simple array", () => {
    ...
    expect(result?.standardDeviation).toBeCloseTo(1.4142, 4);
    expect(result?.coefficientOfVariation).toBeCloseTo(47.14, 2);
  ...
  it("should handle negative values", () => {
    ...
    expect(result?.coefficientOfVariation).toBe(0); // mean is 0
  });

...
export const POPULATION_DYNAMICS_CATALOG: ThemeCatalog = {
  overview: {
    "introduction": "人口規模と増減、出生・転出入を比較。",
    "headlineRankingKeys": [
      "total-population",
    ...
    "mapNotes": {
      "total-population": "人口の規模。増減の速さは人口増減率で比較。",
      "population-growth-rate": "単位は‰（人口千人当たり）。％ではありません。",
      "natural-increase-rate": "出生－死亡を人口千人当たりで表示。負値は自然減。",
      "moving-in-excess-rate": "外国人移動者を含む国内移動。自然増減率とは単位・対象が異なります。",
      "total-fertility-rate": "15～49歳の年齢別出生率の合計。個人の実際の出生数ではありません。",
      "ratio-65-plus": "総人口に占める65歳以上の割合。高齢者の人数とは別です。",
      "young-population-ratio": "総人口に占める15歳未満の割合。出生率とは別です。"
    }
  },
  ...
  "metrics": [
    ...
    },
    {
      ...
      "selection": {
        ...
        "surveyedAt": "2026-09-09",
        "rationale": "NotebookLMで出生数とともに扱う図表2-1-1を確認。人口規模とは独立した出生動向を比較表で補う。"
      }
    },
    {
      ...
      "role": "primary",
      "selection": {
        "proposedBy": "住民基本台帳人口移動報告",
        "sourceUrl": "https://www.stat.go.jp/data/idou/index.html",
        "surveyedAt": "2026-09-09",
        "rationale": "地域間移動の方向を現在の収録年で確認する。2019年までの社会増減率より概況に適するが、単純な足し算の要因分解には使わない。"
      }
    },
    {
      ...
      "selection": {
        ...
        "sourceUrl": "https://www.stat.go.jp/data/jinsui/2024np/index.html",
        "surveyedAt": "2026-09-09",
        "rationale": "増減の背景となる年齢構成を比較表と年齢構成図で確認する。"
      }
    },
    {
      ...
      "selection": {
        ...
        "sourceUrl": "https://www.stat.go.jp/data/jinsui/2024np/index.html",
        "surveyedAt": "2026-09-09",
        "rationale": "人口変化の結果を率で比較する中心指標。公式の都道府県別増減率表・増減要因図を参考に地図と表へ配置する。"
      }
    },
    {
      ...
      "selection": {
        ...
        "sourceUrl": "https://www.stat.go.jp/data/jinsui/2024np/index.html",
        "surveyedAt": "2026-09-09",
        "rationale": "人口減少を出生・死亡の差で説明する。人口増減率と同じ‰だが基礎統計の対象年を併記する。"
      }
    },
    {
    ...
    },
    {
      ...
      "selection": {
        ...
        "sourceUrl": "https://www.stat.go.jp/data/jinsui/2024np/index.html",
        "surveyedAt": "2026-09-09",
        "rationale": "高齢化率と合わせて子どもの人口構成を比較し、出生率との混同を防ぐ。"
      }
    },
    {
  ...
  "charts": [
    {
      ...
      "section": "人口の増減要因",
      "sortOrder": 10,
      "annotation": "同じ年・対象集団の出生と死亡を比較。人口増減率とは単位が異なります。"
    },
    {
      ...
      "section": "人口の増減要因",
      "sortOrder": 20,
      "annotation": "国内の都道府県間移動。人口推計の社会増減全体とは対象が異なります。"
    },
    {
      ...
      "section": "人口構造",
      "sortOrder": 30,
      "annotation": "年齢不詳の扱いは出典に従います。年齢区分の人口を高齢化率と混同しません。"
    },
    {
      ...
      "section": "人口構造",
      "sortOrder": 40,
      "annotation": "選択県の年齢構造。全国との単純な人数比較には人口規模の差があります。"
    },
    {

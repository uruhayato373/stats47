...
export const KNOWN_UNIT_SAMPLES: readonly string[] = ["円", "千円", "万円", "百万円", "億円", "兆円", "％", "%", "‰", "人", "千人", "万人", "人（人口10万対）", "人口千対", "人口10万対", "世帯", "件", "戸", "台", "店", "校", "館", "所", "か所", "箇所", "施設", "事業所", "企業等", "g", "kg", "t", "トン", "ml", "l", "kl", "m3", "mm", "cm", "m", "km", "m2", "ha", "km2", "kWh", "MWh", "時間", "分", "日", "年", "歳", "℃", "指数", "（全国=100）"];

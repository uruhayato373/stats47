...
export const METRIC_POLARITY: Readonly<Record<string, PolarityEntry>> = {
  ...
  "cram-school-establishment-count": { polarity: "neutral", evidence: "学習塾事業所数は市場規模・人口密度・立地条件に依存し、事業所数の多寡を教育機会の充足度とはしない。" },
  ...
  "deaths-cerebral-infarction-per-100k": { polarity: "higher-is-worse", evidence: "人口動態調査の脳梗塞(ICD-10のI63等)死亡率(人口10万対)であり、死亡は争いのない事象で増加を望ましいとは扱わない。" },
  ...
  "fresh-vegetables-consumption-expenditure": { polarity: "neutral", evidence: "生鮮野菜消費支出額は物価・世帯構成・地域の入手のしやすさを反映し、支出額の多寡を食生活の良否とはしない。" },
  ...
  "mothers-age-at-first-birth": { polarity: "neutral", evidence: "第1子出生時の母の平均年齢はキャリア形成・結婚時期・地域の生活選択を反映し、年齢の高低に良否を付けない。" },
  ...
  "nursery-waiting-children-count": { polarity: "neutral", evidence: "保育所等利用待機児童数は受入体制の不足と保育需要(共働き世帯増・転入等)の双方で増減し、件数だけで施策の成果を判定しない。" },
  ...
  "seafood-consumption-expenditure": { polarity: "neutral", evidence: "魚介類消費支出額は物価・世帯構成・地域の入手のしやすさを反映し、支出額の多寡を食生活の良否とはしない。" },
  ...
  "three-generation-household-members": { polarity: "neutral", evidence: "3世代世帯人員は住宅事情・介護分担・地域の家族形態の選好を反映し、多寡に生活の良否を付けない。" },

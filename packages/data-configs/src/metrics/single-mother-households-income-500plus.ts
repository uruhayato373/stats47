...
export const singleMotherHouseholdsIncome500plus: MetricConfig = {
  "key": "single-mother-households-income-500plus",
  "title": "所得500万円以上の母子世帯数",
  "description": "世帯所得500万円以上の母子世帯の推計世帯数。",

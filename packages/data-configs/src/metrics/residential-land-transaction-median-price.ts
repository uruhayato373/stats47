...
export const residentialLandTransactionMedianPrice: MetricConfig = {
  "key": "residential-land-transaction-median-price",
  "title": "住宅地の取引単価中央値（100〜300㎡未満）",
  "unit": "円/m2",
  "category": "construction",
  "note": "公表面積100㎡以上300㎡未満。用途・面積帯以外の立地・接道・形状等は統制していない。2025年中の回答された取引標本。種類=宅地(土地)、地域=住宅地、取引価格01のみ。成約価格02を含まず、全取引件数・全物件相場を示さない。中央値は対象行の公表円/㎡単価を使用。取引面積・価格は公表時に丸められる。総額÷面積の再計算はしない。2025年中の取引と1月1日の公示価格を時点調整していないため、価格差率や割安・割高の判定には使わない。",
  "source": {
    "kind": "external",
    "fetcherKey": "manual",
    "config": {
      ...
      "description": "公式Webで47県を順に選択し、価格情報=取引価格のみ、種類=宅地(土地)、期間=2025年第1～第4四半期、一覧のCSVダウンロード。CP932 CSVの種類=宅地(土地)、地域=住宅地、公表面積100以上300未満、正の有限な取引価格（㎡単価）を採用。上限表記・欠測を別理由で除外。匿名化後の同一行は同一取引と断定せず保持。Hyndman-Fan type 7（h=(n-1)p、線形補間）で中央値を集計。",
      "provenance": {
        ...
        "extraction": "公式Webで47県を順に選択し、価格情報=取引価格のみ、種類=宅地(土地)、期間=2025年第1～第4四半期、一覧のCSVダウンロード。CP932 CSVの種類=宅地(土地)、地域=住宅地、公表面積100以上300未満、正の有限な取引価格（㎡単価）を採用。上限表記・欠測を別理由で除外。匿名化後の同一行は同一取引と断定せず保持。Hyndman-Fan type 7（h=(n-1)p、線形補間）で中央値を集計。",

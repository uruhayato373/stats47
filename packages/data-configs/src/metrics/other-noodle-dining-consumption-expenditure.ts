...
export const otherNoodleDiningConsumptionExpenditure: MetricConfig = {
  "key": "other-noodle-dining-consumption-expenditure",
  "title": "他の麺類外食消費支出額",
  "subtitle": "都道府県庁所在市の二人以上世帯の年間他の麺類外食消費支出額",
  "unit": "円",
  "category": "economy",
  "source": {
    "kind": "kakei-chousa",

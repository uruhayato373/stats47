...
export const videoRecorderConsumptionQuantity: MetricConfig = {
  "key": "video-recorder-consumption-quantity",
  "title": "ビデオレコーダー・プレイヤー消費量",
  "subtitle": "都道府県庁所在市の二人以上世帯の年間ビデオレコーダー・プレイヤー消費量",
  "unit": "台",
  "category": "economy",
  "source": {
    "kind": "kakei-chousa",

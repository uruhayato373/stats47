...
export const employmentLocationQuotientInformationCommunication: MetricConfig = {
  "key": "employment-location-quotient-information-communication",
  "title": "情報通信業の従業者特化係数",
  "description": "情報通信業の従業者特化係数を都道府県別に比較する。",
  ...
  "source": {
    ...
    "config": {
      ...
      "provenance": {
        ...
        "valueColumn": "113-2021 / cat01 G,AR / cat02 0",
        "dataYear": "2021年6月1日",

...
export const singleMotherHouseholdsIncomeUnder100: MetricConfig = {
  "key": "single-mother-households-income-under100",
  "title": "所得100万円未満の母子世帯数",
  "description": "世帯所得100万円未満の母子世帯の推計世帯数。",

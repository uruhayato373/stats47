...
export const businessClosureRate: MetricConfig = {
  "key": "business-closure-rate",
  "title": "廃業率",
  "subtitle": "雇用保険適用事業所",
  "description": "当該年度の雇用保険の保険関係消滅事業所数を前年度末の適用事業所数で割り、100を掛けた割合。",
  ...
  "source": {
    ...
    "config": {
      ...
      "provenance": {
        ...
        "valueColumn": "年報C8:C54 ÷ 同年3月月報D7:D53 × 100",
  ...
  "calculation": {
    ...
    "type": "ratio",
    "scaleFactor": 100,
    "numeratorKey": "business-closure-establishments",

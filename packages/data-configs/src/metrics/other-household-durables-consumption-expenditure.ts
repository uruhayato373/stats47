...
export const otherHouseholdDurablesConsumptionExpenditure: MetricConfig = {
  "key": "other-household-durables-consumption-expenditure",
  "title": "他の家事用耐久財消費支出額",
  "subtitle": "都道府県庁所在市の二人以上世帯の年間他の家事用耐久財消費支出額",
  "unit": "円",
  "category": "economy",
  "source": {
    "kind": "kakei-chousa",

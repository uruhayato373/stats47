...
export const managerAnnualIncome: MetricConfig = {
  ...
  "seoTitle": "管理的職業従事者の平均年収ランキング都道府県【2023年】｜1位東京都（996.3万円）",
  "seoDescription": "2023年の管理的職業従事者の平均年収の都道府県別ランキング。1位東京都（996.3万円）、最下位青森県（606.8万円）で1.6倍の格差。地図やグラフで47都道府県を比較。",
  "isActive": true,
};

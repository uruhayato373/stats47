...
export const steepSlopeSpecialWarningZoneCount: MetricConfig = {
  "key": "steep-slope-special-warning-zone-count",
  "title": "急傾斜地崩壊の特別警戒区域数",
  ...
  "source": {
    ...
    "config": {
      ...
      "provenance": {
        ...
        "valueColumn": "都道府県名右側の数値第4列（急傾斜地崩壊の特別警戒区域数）",

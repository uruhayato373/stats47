...
export const homeNursingVisitCases: MetricConfig = {
  key: 'home-nursing-visit-cases',
  title: '訪問看護・指導の実施件数',
  subtitle: '病院・一般診療所、2023年9月',
  description:
    '病院と一般診療所による在宅患者訪問看護・指導の実施件数を所在地の県別に比較する。',
  note: '2023年9月の1か月間、病院と一般診療所の「医療保険等による在宅患者訪問看護・指導」の実施件数を合計。実人数・年間件数ではない。医療施設の所在地別で、患者の居住県別ではない。訪問看護ステーション、精神科在宅患者訪問看護・指導の別項目、介護保険による訪問看護、訪問介護は含まない。両サービス間は重複し得るため、構成比や合計利用者数を作らない。',
  unit: '件',

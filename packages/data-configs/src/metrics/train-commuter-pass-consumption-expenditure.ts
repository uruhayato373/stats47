...
export const trainCommuterPassConsumptionExpenditure: MetricConfig = {
  "key": "train-commuter-pass-consumption-expenditure",
  "title": "鉄道通勤定期代消費支出額",
  "subtitle": "都道府県庁所在市の二人以上世帯の年間鉄道通勤定期代消費支出額",
  "unit": "円",
  "category": "economy",
  "source": {
    "kind": "kakei-chousa",

...
export const pm25CompliantGeneralStationCount: MetricConfig = {
  "key": "pm25-compliant-general-station-count",
  "title": "PM2.5の環境基準達成局数",
  "subtitle": "一般環境大気測定局",
  "description": "有効な一般環境大気測定局のうち、長期基準と短期基準をともに達成した局数です。",

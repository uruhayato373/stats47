...
export const gardenMaintenanceConsumptionExpenditure: MetricConfig = {
  "key": "garden-maintenance-consumption-expenditure",
  "title": "植木・庭手入れ代消費支出額",
  "subtitle": "都道府県庁所在市の二人以上世帯の年間植木・庭手入れ代消費支出額",
  "unit": "円",
  "category": "economy",
  "source": {
    "kind": "kakei-chousa",

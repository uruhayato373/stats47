...
export const cableTvFeeConsumptionExpenditure: MetricConfig = {
  "key": "cable-tv-fee-consumption-expenditure",
  "title": "ケーブルテレビ放送受信料消費支出額",
  "subtitle": "都道府県庁所在市の二人以上世帯の年間ケーブルテレビ放送受信料消費支出額",
  "unit": "円",
  "category": "economy",
  "source": {
    "kind": "kakei-chousa",

...
export const birthsMotherAge40plus: MetricConfig = {
  key: 'births-mother-age40plus',
  title: '母が40歳以上の出生数',
  subtitle: '2024年・子の住所地別・確定数',
  description: '母が40歳以上の出生数を子の住所地の都道府県別に比較する。',
  ...
  source: {
    kind: 'estat',
    statsDataId: '0003411631',
    cdTab: '10040',
    cdCat02: '00100',
    displayName: '人口動態統計',
    url: 'https://www.e-stat.go.jp/dbview?sid=0003411631',
    axisSum: {
      axis: 'cat01',
      codes: ['00280', '00300', '00310'],
    },
  },
  entities: ['prefecture'],
  years: {

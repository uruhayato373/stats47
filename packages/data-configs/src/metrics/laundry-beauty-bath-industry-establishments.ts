...
export const laundryBeautyBathIndustryEstablishments: MetricConfig = {
  "key": "laundry-beauty-bath-industry-establishments",
  "title": "洗濯・理容・美容・浴場業の事業所数",
  "description": "洗濯・理容・美容・浴場業の事業所数を都道府県別に比較する。",

...
export const juniorHighTutoringConsumptionExpenditure: MetricConfig = {
  "key": "junior-high-tutoring-consumption-expenditure",
  "title": "中学校補習教育消費支出額",
  "subtitle": "都道府県庁所在市の二人以上世帯の年間中学校補習教育消費支出額",
  "unit": "円",
  "category": "economy",
  "source": {
    "kind": "kakei-chousa",

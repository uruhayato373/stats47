...
export const roadBridgeDiagnosedCount: MetricConfig = {
  "key": "road-bridge-diagnosed-count",
  "title": "道路橋の診断済総数",
  "subtitle": "全道路管理者・施設所在地別",
  "description": "2025年度末時点の道路橋について、2014〜2025年度に実施した点検の最新の健全性診断を都道府県別に集計した診断済総数。",

...
export const furusatoTaxDeductionPrefecturalPrefecture: MetricConfig = {
  "key": "furusato-tax-deduction-prefectural-prefecture",
  "title": "ふるさと納税の道府県民税控除額",
  "subtitle": "県内課税分・推計値含む",
  "description": "県内全市区町村の課税におけるふるさと納税に係る道府県民税控除額を都道府県別に集計。寄附の受入先の集計ではない。",

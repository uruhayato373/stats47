...
export const nonprimaryEnterprisesUnder5Employees: MetricConfig = {
  "key": "nonprimary-enterprises-under5-employees",
  "title": "常用雇用者0〜4人企業の従業者数",
  "description": "経済センサスの企業等に関する集計における、本所所在地別の常用雇用者0〜4人企業の従業者数。会社企業と個人経営の合計。",

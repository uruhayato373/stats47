...
export const householdSurveyEducationExpenditure: MetricConfig = {
  "key": "household-survey-education-expenditure",
  "title": "教育支出",
  "subtitle": "都道府県全域・二人以上世帯・10〜11月の月平均",
  "description": "全国家計構造調査の二人以上の世帯について、「教育支出」の10月と11月の2か月を平均した1世帯当たり月平均額です。都道府県全域を対象とし、用途分類を使用します。",

...
export const elementary5WeeklyExercise420minRateMale: MetricConfig = {
  "key": "elementary5-weekly-exercise-420min-rate-male",
  "title": "小学5年男子の週420分以上運動割合",
  "subtitle": "公立・体育授業を除く・有効回答者",
  "description": "小学5年男子の週420分以上運動割合を47都道府県で比較します。",
  ...
  "source": {
    ...
    "config": {
      ...
      "provenance": {
        ...
        "table": "PDF7頁（印刷200頁）公立都道府県別 男子 420分以上列",
        "valueColumn": "PDF7頁（印刷200頁）公立都道府県別 男子 420分以上列",

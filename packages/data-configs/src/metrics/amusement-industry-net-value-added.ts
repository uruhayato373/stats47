...
export const amusementIndustryNetValueAdded: MetricConfig = {
  "key": "amusement-industry-net-value-added",
  "title": "娯楽業の企業純付加価値額",
  "description": "娯楽業の企業純付加価値額を都道府県別に比較します。企業本所所在地別の2020年実績です。",
  ...
  "source": {
    ...
    "config": {
      ...
      "provenance": {
        ...
        "valueColumn": "261-2021 企業純付加価値額、企業産業中分類80",

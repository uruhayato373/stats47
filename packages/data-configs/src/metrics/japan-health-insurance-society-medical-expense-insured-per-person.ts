...
export const japanHealthInsuranceSocietyMedicalExpenseInsuredPerPerson: MetricConfig = {
  "key": "japan-health-insurance-society-medical-expense-insured-per-person",

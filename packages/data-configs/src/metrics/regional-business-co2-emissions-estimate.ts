...
export const regionalBusinessCo2EmissionsEstimate: MetricConfig = {
  "key": "regional-business-co2-emissions-estimate",
  "title": "業務その他部門のCO₂排出量推計",
  "subtitle": "標準的手法による活動量按分",
  "description": "業務その他部門のCO₂排出量推計を47都道府県で比較します。",
  ...
  "source": {
    ...
    "config": {
      ...
      "provenance": {
        ...
        "table": "2023_一覧表!I3:I1743 をA列の県コードで集計",
        "valueColumn": "2023_一覧表!I3:I1743 をA列の県コードで集計",

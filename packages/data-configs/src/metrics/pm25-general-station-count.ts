...
export const pm25GeneralStationCount: MetricConfig = {
  "key": "pm25-general-station-count",
  "title": "PM2.5の一般環境大気測定局数",
  "description": "PM2.5を測定する一般環境大気測定局の総数です。有効測定局以外も含みます。",

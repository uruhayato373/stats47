...
export const otherBroadcastFeeConsumptionExpenditure: MetricConfig = {
  "key": "other-broadcast-fee-consumption-expenditure",
  "title": "他の放送受信料消費支出額",
  "subtitle": "都道府県庁所在市の二人以上世帯の年間他の放送受信料消費支出額",
  "unit": "円",
  "category": "economy",
  "source": {
    "kind": "kakei-chousa",

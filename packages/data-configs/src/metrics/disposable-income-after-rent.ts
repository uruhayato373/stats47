...
export const disposableIncomeAfterRent: MetricConfig = {
  ...
  // 期間是正 (2026-08-05) 後の実データから機械算出した値。旧文言は控除額が 12 倍過大
  // だった時代のもので「1位山形県 545,206円・最下位沖縄県 167,326円・3.3倍」と書いていた。
  "seoTitle": "家賃控除後可処分所得ランキング都道府県【2024年】｜1位東京都（623,317円）",
  "seoDescription": "2024年の家賃控除後可処分所得の都道府県別ランキング。1位東京都（623,317円）、最下位沖縄県（402,541円）で1.5倍の格差。地図やグラフで47都道府県を比較。",
  "isActive": true,
};

...
export const pickledChineseCabbageConsumptionExpenditure: MetricConfig = {
  "key": "pickled-chinese-cabbage-consumption-expenditure",
  "title": "はくさい漬消費支出額",
  "subtitle": "都道府県庁所在市の二人以上世帯の年間はくさい漬消費支出額",
  "unit": "円",
  "category": "economy",
  "source": {
    "kind": "kakei-chousa",

...
export const healthInsurancePremiumConsumptionExpenditure: MetricConfig = {
  "key": "health-insurance-premium-consumption-expenditure",
  "title": "医療保険料消費支出額",
  "subtitle": "都道府県庁所在市の二人以上世帯の年間医療保険料消費支出額",
  "unit": "円",
  "category": "economy",
  "source": {
    "kind": "kakei-chousa",

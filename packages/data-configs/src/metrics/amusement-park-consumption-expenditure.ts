...
export const amusementParkConsumptionExpenditure: MetricConfig = {
  "key": "amusement-park-consumption-expenditure",
  "title": "遊園地入場・乗物代消費支出額",
  "subtitle": "都道府県庁所在市の二人以上世帯の年間遊園地入場・乗物代消費支出額",
  "unit": "円",
  "category": "economy",
  "source": {
    "kind": "kakei-chousa",

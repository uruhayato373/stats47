...
export const individualEvacuationPlanListedPersons: MetricConfig = {
  key: 'individual-evacuation-plan-listed-persons',
  title: '避難行動要支援者名簿の掲載人数',
  subtitle: '2026年4月1日現在',
  description: '避難行動要支援者名簿の掲載人数を都道府県別に比較する。',
  note: '2026年4月1日現在の全1,741市区町村の行政取組状況を都道府県別に集計。個別避難計画が作成された現在の要支援者を対象とし、施設入所等で対象から外れた人を含む過去累計や直近1年間の作成件数とは異なる。分母は避難行動要支援者名簿の掲載人数で、各自治体の優先作成対象者数ではない。掲載対象の基準は自治体で異なり、作成率を実際の避難成功率や支援の十分さとみなさない。',
  unit: '人',

...
export const heaterConsumptionExpenditure: MetricConfig = {
  "key": "heater-consumption-expenditure",
  "title": "ストーブ・温風ヒーター消費支出額",
  "subtitle": "都道府県庁所在市の二人以上世帯の年間ストーブ・温風ヒーター消費支出額",
  "unit": "円",
  "category": "economy",
  "source": {
    "kind": "kakei-chousa",

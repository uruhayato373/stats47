...
export const monthlyParkingConsumptionExpenditure: MetricConfig = {
  "key": "monthly-parking-consumption-expenditure",
  "title": "年極・月極駐車場借料消費支出額",
  "subtitle": "都道府県庁所在市の二人以上世帯の年間年極・月極駐車場借料消費支出額",
  "unit": "円",
  "category": "economy",
  "source": {
    "kind": "kakei-chousa",

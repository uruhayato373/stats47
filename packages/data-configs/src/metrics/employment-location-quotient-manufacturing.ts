...
export const employmentLocationQuotientManufacturing: MetricConfig = {
  "key": "employment-location-quotient-manufacturing",
  "title": "製造業の従業者特化係数",
  "description": "製造業の従業者特化係数を都道府県別に比較する。",
  ...
  "source": {
    ...
    "config": {
      ...
      "provenance": {
        ...
        "valueColumn": "113-2021 / cat01 E,AR / cat02 0",
        "dataYear": "2021年6月1日",

...
export const furusatoDonationCountPrefecture: MetricConfig = {
  "key": "furusato-donation-count-prefecture",
  "title": "ふるさと納税受入件数",
  "subtitle": "都道府県自身・決算見込",
  "description": "ふるさと納税受入件数の都道府県自身の実績。県内市区町村分は含みません。",
  ...
  "source": {
    ...
    "config": {
      ...
      "provenance": {
        ...
        "valueColumn": "D列、A列の団体コード先頭5桁がNN000の47団体",

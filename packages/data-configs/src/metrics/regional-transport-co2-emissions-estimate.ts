...
export const regionalTransportCo2EmissionsEstimate: MetricConfig = {
  "key": "regional-transport-co2-emissions-estimate",
  "title": "運輸部門のCO₂排出量推計",
  "subtitle": "自動車・鉄道・船舶。航空を含まない",
  "description": "運輸部門のCO₂排出量推計を47都道府県で比較します。",
  ...
  "source": {
    ...
    "config": {
      ...
      "provenance": {
        ...
        "table": "2023_一覧表!P3:P1743 をA列の県コードで集計",
        "valueColumn": "2023_一覧表!P3:P1743 をA列の県コードで集計",

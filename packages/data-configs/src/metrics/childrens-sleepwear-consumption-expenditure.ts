...
export const childrensSleepwearConsumptionExpenditure: MetricConfig = {
  "key": "childrens-sleepwear-consumption-expenditure",
  "title": "子供用寝巻き消費支出額",
  "subtitle": "都道府県庁所在市の二人以上世帯の年間子供用寝巻き消費支出額",
  "unit": "円",
  "category": "economy",
  "source": {
    "kind": "kakei-chousa",

...
export const prefecturalAutoEnvironmentTaxOnlineApplicationRate: MetricConfig = {
  "key": "prefectural-auto-environment-tax-online-application-rate",
  "title": "自動車税環境性能割の申告納付のオンライン申請率",
  "subtitle": "都道府県行政",
  "description": "都道府県政府の回答値を比較します。市区町村の値を県内合算したものではありません。",
  "note": "令和6年度調査に収録された2023年度（令和5年度）利用実績。調査年度・公表年度を観測年度として扱わない。 県内市町村の利用率ではなく、都道府県行政への同じ自動車税環境性能割申告納付手続の回答値。 原表Y列のオンライン申請率。100×オンライン申請件数（X列）÷申請総件数（W列）。",
  "unit": "%",

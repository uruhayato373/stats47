...
export const vegetableIntakeFemaleAgeAdjusted: MetricConfig = {
  "key": "vegetable-intake-female-age-adjusted",
  "title": "女性の野菜摂取量（年齢調整値）",
  "description": "国民健康・栄養調査による20歳以上の女性の1日当たり野菜摂取量。",

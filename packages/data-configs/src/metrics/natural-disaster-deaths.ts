...
export const naturalDisasterDeaths: MetricConfig = {
  key: 'natural-disaster-deaths',
  title: '自然災害による死者数',
  subtitle: '2024年（2025年4月1日現在）',
  description: '自然災害による死者数を都道府県別に比較する。',
  note: '2024年1月1日〜12月31日に発生した自然災害等の都道府県別被害。2025年4月1日現在に固定した消防白書の集計で、後の災害関連死認定等を反映した最新被害速報とは一致しない場合がある。自然災害は暴風・竜巻・豪雨・豪雪・洪水・崖崩れ・土石流・高潮・地震・津波・噴火・地滑り等。人数と住家棟数は合算しない。 死者は災害関連死を含む。内数の災害関連死者数を再加算しない。',
  unit: '人',

...
export const furusatoDonationAmountPrefecture: MetricConfig = {
  "key": "furusato-donation-amount-prefecture",
  "title": "ふるさと納税受入額",
  "subtitle": "都道府県自身・決算見込",
  "description": "ふるさと納税受入額の都道府県自身の実績。県内市区町村分は含みません。",
  ...
  "source": {
    ...
    "config": {
      ...
      "provenance": {
        ...
        "valueColumn": "E列、A列の団体コード先頭5桁がNN000の47団体",

...
export const movieTheaterConsumptionExpenditure: MetricConfig = {
  "key": "movie-theater-consumption-expenditure",
  "title": "映画・演劇等入場料消費支出額",
  "subtitle": "都道府県庁所在市の二人以上世帯の年間映画・演劇等入場料消費支出額",
  "unit": "円",
  "category": "economy",
  "source": {
    "kind": "kakei-chousa",

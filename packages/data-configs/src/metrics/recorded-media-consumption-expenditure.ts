...
export const recordedMediaConsumptionExpenditure: MetricConfig = {
  "key": "recorded-media-consumption-expenditure",
  "title": "音楽・映像収録済メディア消費支出額",
  "subtitle": "都道府県庁所在市の二人以上世帯の年間音楽・映像収録済メディア消費支出額",
  "unit": "円",
  "category": "economy",
  "source": {
    "kind": "kakei-chousa",

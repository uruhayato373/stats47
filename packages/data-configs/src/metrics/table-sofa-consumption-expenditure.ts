...
export const tableSofaConsumptionExpenditure: MetricConfig = {
  "key": "table-sofa-consumption-expenditure",
  "title": "テーブル・ソファー消費支出額",
  "subtitle": "都道府県庁所在市の二人以上世帯の年間テーブル・ソファー消費支出額",
  "unit": "円",
  "category": "economy",
  "source": {
    "kind": "kakei-chousa",

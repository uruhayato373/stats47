...
export const deepFriedFishCakeConsumptionExpenditure: MetricConfig = {
  "key": "deep-fried-fish-cake-consumption-expenditure",
  "title": "揚げかまぼこ消費支出額",
  "subtitle": "都道府県庁所在市の二人以上世帯の年間揚げかまぼこ消費支出額",
  "unit": "円",
  "category": "economy",
  "source": {
    "kind": "kakei-chousa",

...
export const foodManufacturingShipmentAmount: MetricConfig = {
  "key": "food-manufacturing-shipment-amount",
  "title": "食料品製造業の製造品出荷額等",
  "subtitle": "中分類09・個人経営を除く全規模・再集計参考値",
  "description": "2023年1～12月の製造品出荷額等。原則消費税込み。",
  "note": "2024年経済構造実態調査・製造業事業所調査の参考値（2026年7月29日公表、令和6年経済センサス‐基礎調査反映の再集計）。個人経営・管理補助活動のみの事業所等を除き、全従業者規模を推計。日本標準産業分類中分類09（食料品製造業）に限定し、飲料・たばこ・飼料製造業、農業、卸小売、外食を含めない。 出荷額は2023暦年実績で、事業所・従業者の2024年6月時点と対象時点が異なる。",
  "unit": "百万円",
  ...
  "source": {
    ...
    "config": {
      ...
      "provenance": {
        ...
        "valueColumn": "L列: 食料品製造業の製造品出荷額等",
        "dataYear": "2023年（2024年調査・再集計参考値）",

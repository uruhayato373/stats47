...
export const inboundVisitorsByDestination: MetricConfig = {
  key: 'inbound-visitors-by-destination',
  title: '訪日外国人の都道府県別訪問者数',
  subtitle: '2025年・全目的・一般客',
  description:
    '2025年の全目的・宿泊と日帰りを含む訪日外国人一般客の訪問先都道府県別集計。',
  ...
  source: {
    ...
    config: {
      ...
      provenance: {
        ...
        valueColumn: 'E9:E55（訪問地B列、県番号A列）',
        dataYear: '2025年（暦年）',

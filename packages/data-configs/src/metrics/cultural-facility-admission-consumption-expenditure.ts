...
export const culturalFacilityAdmissionConsumptionExpenditure: MetricConfig = {
  "key": "cultural-facility-admission-consumption-expenditure",
  "title": "文化施設入場料消費支出額",
  "subtitle": "都道府県庁所在市の二人以上世帯の年間文化施設入場料消費支出額",
  "unit": "円",
  "category": "economy",
  "source": {
    "kind": "kakei-chousa",

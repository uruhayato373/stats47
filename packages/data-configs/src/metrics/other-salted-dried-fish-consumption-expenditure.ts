...
export const otherSaltedDriedFishConsumptionExpenditure: MetricConfig = {
  "key": "other-salted-dried-fish-consumption-expenditure",
  "title": "他の塩干魚介消費支出額",
  "subtitle": "都道府県庁所在市の二人以上世帯の年間他の塩干魚介消費支出額",
  "unit": "円",
  "category": "economy",
  "source": {
    "kind": "kakei-chousa",

...
export const fitFipNewApprovedInstalledCapacity: MetricConfig = {
  "key": "fit-fip-new-approved-installed-capacity",
  "title": "FIT・FIP再エネ導入設備容量（新規認定分）",
  "subtitle": "制度開始後に認定された設備の累積導入容量",
  "description": "FIT・FIP再エネ導入設備容量（新規認定分）を47都道府県で比較します。",

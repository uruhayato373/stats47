...
export const vegetableIntakeMaleAgeAdjusted: MetricConfig = {
  "key": "vegetable-intake-male-age-adjusted",
  "title": "男性の野菜摂取量（年齢調整値）",
  "description": "国民健康・栄養調査による20歳以上の男性の1日当たり野菜摂取量。",

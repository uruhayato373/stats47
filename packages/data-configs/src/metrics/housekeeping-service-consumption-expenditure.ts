...
export const housekeepingServiceConsumptionExpenditure: MetricConfig = {
  "key": "housekeeping-service-consumption-expenditure",
  "title": "家事代行料消費支出額",
  "subtitle": "都道府県庁所在市の二人以上世帯の年間家事代行料消費支出額",
  "unit": "円",
  "category": "economy",
  "source": {
    "kind": "kakei-chousa",

...
export const mediaProductionRevenue: MetricConfig = {
  "key": "media-production-revenue",
  "title": "映像・音声・文字情報制作業の企業売上高",
  "description": "映像・音声・文字情報制作業の企業売上高を都道府県別に比較します。企業本所所在地別の2020年実績です。",
  ...
  "source": {
    ...
    "config": {
      ...
      "provenance": {
        ...
        "valueColumn": "250-2021 企業売上高、企業産業中分類41",

...
export const laundryBeautyBathIndustryRevenue: MetricConfig = {
  "key": "laundry-beauty-bath-industry-revenue",
  "title": "洗濯・理容・美容・浴場業の企業売上高",
  "description": "洗濯・理容・美容・浴場業の企業売上高を都道府県別に比較する。",

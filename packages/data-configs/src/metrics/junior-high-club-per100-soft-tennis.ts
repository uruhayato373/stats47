...
export const juniorHighClubPer100SoftTennis: MetricConfig = {
  "key": "junior-high-club-per100-soft-tennis",
  "title": "中学部活動 100人あたり部員数",
  "subtitle": "ソフトテニス部",
  "unit": "人",
  "category": "educationsports",
  "note": "運動部の加盟生徒数(男女計)を中学校生徒数100人あたりに換算した値。中体連加盟(令和7年度・令和7年6月1日現在)のソフトテニス部生徒数を用いた。",
  "source": {
    "kind": "external",
    "fetcherKey": "manual",
    "config": {
      ...
      "description": "中学校の運動部活動のうちソフトテニス部の加盟生徒数(男女計)を、都道府県別の中学校生徒数100人あたりに換算した値。分子=中体連「加盟生徒数(ソフトテニス部・男子+女子)」(加盟生徒数(男子)/(女子)ページ)、分母=学校基本調査 中学校生徒数(2024年度、metric: junior-high-school-students-count)。",
      "provenance": {
        ...
        "table": "加盟生徒数(男子)/加盟生徒数(女子) のソフトテニス列",
        "pdfPage": 5,
        "valueColumn": "ソフトテニス(男子ページ5・女子ページ6の該当列を合算)",

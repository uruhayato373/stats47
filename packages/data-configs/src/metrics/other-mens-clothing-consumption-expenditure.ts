...
export const otherMensClothingConsumptionExpenditure: MetricConfig = {
  "key": "other-mens-clothing-consumption-expenditure",
  "title": "他の男子用洋服消費支出額",
  "subtitle": "都道府県庁所在市の二人以上世帯の年間他の男子用洋服消費支出額",
  "unit": "円",
  "category": "economy",
  "source": {
    "kind": "kakei-chousa",

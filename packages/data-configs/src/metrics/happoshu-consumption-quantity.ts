...
export const happoshuConsumptionQuantity: MetricConfig = {
  "key": "happoshu-consumption-quantity",
  "title": "発泡酒・ビール風アルコール飲料消費量",
  "subtitle": "都道府県庁所在市の二人以上世帯の年間発泡酒・ビール風アルコール飲料消費量",
  "unit": "l",
  "category": "economy",
  "source": {
    "kind": "kakei-chousa",

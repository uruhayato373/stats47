...
export const informationPrivateEmployees: MetricConfig = {
  "key": "information-private-employees",
  "title": "情報通信業従業者数（民営）",
  "description": "経済センサスの民営事業所のうち、情報通信業に分類される事業所の従業者数。事業所が所在する都道府県ごとに集計する。",

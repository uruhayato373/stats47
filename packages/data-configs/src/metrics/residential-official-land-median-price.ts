...
export const residentialOfficialLandMedianPrice: MetricConfig = {
  "key": "residential-official-land-median-price",
  "title": "住宅地の公示価格中央値（100〜300㎡未満）",
  "unit": "円/m2",
  "category": "construction",
  "note": "公表面積100㎡以上300㎡未満。用途・面積帯以外の立地・接道・形状等は統制していない。2025年1月1日時点の住宅地標準地（用途000）。鑑定士別評価額ではなく公示価格の1標準地1行を用いる。中央値は対象行の公表円/㎡単価を使用。2025年中の取引と1月1日の公示価格を時点調整していないため、価格差率や割安・割高の判定には使わない。",
  "source": {
    "kind": "external",
    "fetcherKey": "manual",
    "config": {
      ...
      "description": "公式KSJ L01-2025全国CSVをCP932で読込。番号用途区分=000、地積100以上300未満、価格R07の正の有限値を採用。行政区域コード・番号用途区分・番号連番の複合キーを一意に保持。GeoJSONのL01_008/027/007と全25,563行を照合。Hyndman-Fan type 7（h=(n-1)p、線形補間）で中央値を集計。",
      "provenance": {
        ...
        "extraction": "公式KSJ L01-2025全国CSVをCP932で読込。番号用途区分=000、地積100以上300未満、価格R07の正の有限値を採用。行政区域コード・番号用途区分・番号連番の複合キーを一意に保持。GeoJSONのL01_008/027/007と全25,563行を照合。Hyndman-Fan type 7（h=(n-1)p、線形補間）で中央値を集計。",

...
export const otherSchoolStationeryConsumptionExpenditure: MetricConfig = {
  "key": "other-school-stationery-consumption-expenditure",
  "title": "他の学習用文房具消費支出額",
  "subtitle": "都道府県庁所在市の二人以上世帯の年間他の学習用文房具消費支出額",
  "unit": "円",
  "category": "economy",
  "source": {
    "kind": "kakei-chousa",

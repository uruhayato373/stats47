...
export const gasCookingApplianceConsumptionExpenditure: MetricConfig = {
  "key": "gas-cooking-appliance-consumption-expenditure",
  "title": "炊事用ガス器具消費支出額",
  "subtitle": "都道府県庁所在市の二人以上世帯の年間炊事用ガス器具消費支出額",
  "unit": "円",
  "category": "economy",
  "source": {
    "kind": "kakei-chousa",

...
export const photoPrintingConsumptionExpenditure: MetricConfig = {
  "key": "photo-printing-consumption-expenditure",
  "title": "写真撮影・プリント代消費支出額",
  "subtitle": "都道府県庁所在市の二人以上世帯の年間写真撮影・プリント代消費支出額",
  "unit": "円",
  "category": "economy",
  "source": {
    "kind": "kakei-chousa",

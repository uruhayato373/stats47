...
export const otherIndoorFurnishingConsumptionExpenditure: MetricConfig = {
  "key": "other-indoor-furnishing-consumption-expenditure",
  "title": "他の室内装備品消費支出額",
  "subtitle": "都道府県庁所在市の二人以上世帯の年間他の室内装備品消費支出額",
  "unit": "円",
  "category": "economy",
  "source": {
    "kind": "kakei-chousa",

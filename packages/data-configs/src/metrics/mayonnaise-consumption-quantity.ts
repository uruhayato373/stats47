...
export const mayonnaiseConsumptionQuantity: MetricConfig = {
  "key": "mayonnaise-consumption-quantity",
  "title": "マヨネーズ・マヨネーズ風調味料消費量",
  "subtitle": "都道府県庁所在市の二人以上世帯の年間マヨネーズ・マヨネーズ風調味料消費量",
  "unit": "g",
  "category": "economy",
  "source": {
    "kind": "kakei-chousa",

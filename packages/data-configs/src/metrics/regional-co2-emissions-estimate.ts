...
export const regionalCo2EmissionsEstimate: MetricConfig = {
  "key": "regional-co2-emissions-estimate",
  "title": "地域のCO₂排出量推計",
  "subtitle": "標準的手法・エネルギー起源と一般廃棄物焼却",
  "description": "地域のCO₂排出量推計を47都道府県で比較します。",
  ...
  "source": {
    ...
    "config": {
      ...
      "provenance": {
        ...
        "table": "2023_一覧表!R3:R1743 をA列の県コードで集計",
        "valueColumn": "2023_一覧表!R3:R1743 をA列の県コードで集計",

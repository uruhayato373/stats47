...
export const residentialBuildingConstructionCost: MetricConfig = {
  ...
  "seoTitle": "着工居住用建築物工事費予定額ランキング都道府県【2024年】｜1位東京都（329,626,666万円）",
  "seoDescription": "2024年の着工居住用建築物工事費予定額の都道府県別ランキング。1位東京都（329,626,666万円）、最下位高知県（4,992,959万円）で66.0倍の格差。地図やグラフで47都道府県を比較。",
  "isActive": true,
  "isFeatured": false,
  "featuredOrder": 0,
};

...
export const pm25ValidGeneralStationCount: MetricConfig = {
  "key": "pm25-valid-general-station-count",
  "title": "PM2.5の有効な一般環境大気測定局数",
  "description": "等価性が確認された測定機器を使用し、年間測定日数が250日以上の一般環境大気測定局数です。",
  ...
  "source": {
    ...
    "config": {
      ...
      "provenance": {
        ...
        "valueColumn": "一般局・令和4〜6年度・有効測定局数",

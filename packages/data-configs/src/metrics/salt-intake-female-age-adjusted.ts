...
export const saltIntakeFemaleAgeAdjusted: MetricConfig = {
  "key": "salt-intake-female-age-adjusted",
  "title": "女性の食塩摂取量（年齢調整値）",
  "description": "国民健康・栄養調査による20歳以上の女性の1日当たり食塩摂取量。",

...
export const constructionEmployedAge30to54: MetricConfig = {
  "key": "construction-employed-age30to54",
  "title": "建設業の30〜54歳就業者数",
  "description": "国勢調査における常住地別の建設業の30〜54歳就業者数。産業大分類D（建設業）、労働力状態は就業者総数。",

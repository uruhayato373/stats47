...
export const mediaProductionNetValueAdded: MetricConfig = {
  "key": "media-production-net-value-added",
  "title": "映像・音声・文字情報制作業の企業純付加価値額",
  "description": "映像・音声・文字情報制作業の企業純付加価値額を都道府県別に比較します。企業本所所在地別の2020年実績です。",
  "note": "2020年1年間の経理事項。必要な数値が得られた企業等を本所所在地別に集計し、原則消費税込み。企業全体の主業で分類しているため、事業所所在地別の従業者数と割り算して生産性を作れません。2021年調査の時間コードを実績年2020へ明示的に対応付けています。金額の単位未満四捨五入により県合計と全国値に差があります。日本標準産業分類の中分類41を対象とし、文化産業全体や地域GDPではありません。",
  "unit": "百万円",
  "category": "economy",
  "source": {
    "kind": "external",
    ...
    "config": {
      ...
      "provenance": {
        ...
        "valueColumn": "261-2021 企業純付加価値額、企業産業中分類41",

...
export const fitFipInstalledCapacity: MetricConfig = {
  "key": "fit-fip-installed-capacity",
  "title": "FIT・FIP再エネ導入設備容量",
  "subtitle": "新規認定分と旧制度移行分の累積合計",
  "description": "FIT・FIP再エネ導入設備容量を47都道府県で比較します。",
  ...
  "source": {
    ...
    "config": {
      ...
      "provenance": {
        ...
        "table": "表A②－１!AI6:AI52 + 表A②－２!AH6:AH52",
        "valueColumn": "表A②－１!AI6:AI52 + 表A②－２!AH6:AH52",

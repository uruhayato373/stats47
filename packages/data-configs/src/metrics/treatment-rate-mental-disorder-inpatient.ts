...
export const treatmentRateMentalDisorderInpatient: MetricConfig = {
  ...
  "seoTitle": "精神及び行動の障害の受療率（入院）ランキング都道府県【2023年】｜1位鹿児島県（413人（人口10万対））",
  "seoDescription": "2023年の精神及び行動の障害の受療率（入院）の都道府県別ランキング。1位鹿児島県（413人（人口10万対））、最下位神奈川県（103人（人口10万対））で4.0倍の格差。地図やグラフで47都道府県を比較。",
  "isActive": true,
  "isFeatured": false,
  "featuredOrder": 0,
};

...
export const otherHeatingCoolingConsumptionExpenditure: MetricConfig = {
  "key": "other-heating-cooling-consumption-expenditure",
  "title": "他の冷暖房用器具消費支出額",
  "subtitle": "都道府県庁所在市の二人以上世帯の年間他の冷暖房用器具消費支出額",
  "unit": "円",
  "category": "economy",
  "source": {
    "kind": "kakei-chousa",

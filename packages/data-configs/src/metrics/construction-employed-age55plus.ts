...
export const constructionEmployedAge55plus: MetricConfig = {
  "key": "construction-employed-age55plus",
  "title": "建設業の55歳以上就業者数",
  "description": "国勢調査における常住地別の建設業の55歳以上就業者数。産業大分類D（建設業）、労働力状態は就業者総数。",

...
export const publicWaterPipeAgingRate: MetricConfig = {
  key: 'public-water-pipe-aging-rate',
  title: '水道管路の経年化率',
  subtitle: '地方公営企業・法適用水道（上水道・簡易水道・用水供給）',
  description:
    '事業団体の所属県別に、法適用水道の水道管路の経年化率を比較します。経年化と更新の分母には同じ年度末の管路総延長を用います。',
  ...
  source: {
    ...
    config: {
      ...
      provenance: {
        ...
        formula:
          '100 * sum(列060 + 列061 + 列062) / sum(列013 + 列014 + 列015)',
      },
      valueField: 'agingRate',
    },
  },
  entities: ['prefecture'],
  years: {

...
export const regionalWasteCo2EmissionsEstimate: MetricConfig = {
  "key": "regional-waste-co2-emissions-estimate",
  "title": "一般廃棄物焼却のCO₂排出量推計",
  "subtitle": "プラスチックごみ・合成繊維の焼却由来",
  "description": "一般廃棄物焼却のCO₂排出量推計を47都道府県で比較します。",
  ...
  "source": {
    ...
    "config": {
      ...
      "provenance": {
        ...
        "table": "2023_一覧表!Q3:Q1743 をA列の県コードで集計",
        "valueColumn": "2023_一覧表!Q3:Q1743 をA列の県コードで集計",

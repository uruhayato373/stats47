...
export const nonprimaryEnterprisesCount: MetricConfig = {
  "key": "nonprimary-enterprises-count",
  "title": "非農林漁業の企業数（会社・個人）",
  "description": "経済センサスの企業等に関する集計における、本所所在地別の非農林漁業の企業数（会社・個人）。会社企業と個人経営の合計。",

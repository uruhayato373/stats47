...
export const prefecturalEltaxOnlineApplicationRate: MetricConfig = {
  "key": "prefectural-eltax-online-application-rate",
  "title": "地方税申告手続（eLTAX）のオンライン申請率",
  "subtitle": "都道府県行政",

...
export const healthCheckupLateDinnerRate: MetricConfig = {
  "key": "health-checkup-late-dinner-rate",
  "title": "就寝前2時間以内の夕食が週3回以上の割合",
  "description": "NDB特定健診質問票の質問15に「はい」と回答した人の割合（男女合計、年度末年齢40〜74歳）。",

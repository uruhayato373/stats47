...
export const furusatoReturnGiftShippingCostPrefecture: MetricConfig = {
  "key": "furusato-return-gift-shipping-cost-prefecture",
  "title": "ふるさと納税返礼品送付費",
  "subtitle": "都道府県自身・決算見込",
  "description": "ふるさと納税返礼品送付費の都道府県自身の実績。県内市区町村分は含みません。",
  ...
  "source": {
    ...
    "config": {
      ...
      "provenance": {
        ...
        "valueColumn": "M列、A列の団体コード先頭5桁がNN000の47団体",

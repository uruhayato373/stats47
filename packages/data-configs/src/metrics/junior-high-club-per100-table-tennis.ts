...
export const juniorHighClubPer100TableTennis: MetricConfig = {
  "key": "junior-high-club-per100-table-tennis",
  "title": "中学部活動 100人あたり部員数",
  "subtitle": "卓球部",
  "unit": "人",
  "category": "educationsports",
  "note": "運動部の加盟生徒数(男女計)を中学校生徒数100人あたりに換算した値。中体連加盟(令和7年度・令和7年6月1日現在)の卓球部生徒数を用いた。",
  "source": {
    "kind": "external",
    "fetcherKey": "manual",
    "config": {
      ...
      "description": "中学校の運動部活動のうち卓球部の加盟生徒数(男女計)を、都道府県別の中学校生徒数100人あたりに換算した値。分子=中体連「加盟生徒数(卓球部・男子+女子)」(加盟生徒数(男子)/(女子)ページ)、分母=学校基本調査 中学校生徒数(2024年度、metric: junior-high-school-students-count)。",
      "provenance": {
        ...
        "table": "加盟生徒数(男子)/加盟生徒数(女子) の卓球列",
        "pdfPage": 5,
        "valueColumn": "卓球(男子ページ5・女子ページ6の該当列を合算)",
  ...
  "seoTitle": "中学卓球部の加入率、都道府県で差｜1位茨城県9.18人 vs 最下位沖縄県2.14人【2025年】",
  "seoDescription": "中学校の卓球部(運動部活動)の加盟部員数を中学生100人あたりに換算し都道府県別に比較。1位茨城県(9.18人)、最下位沖縄県(2.14人)で最大4.3倍の差。地図とグラフで47都道府県を比較。",
  "isActive": true,
};

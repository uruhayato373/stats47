...
export const interiorDecorationConsumptionExpenditure: MetricConfig = {
  "key": "interior-decoration-consumption-expenditure",
  "title": "室内装飾品消費支出額",
  "subtitle": "都道府県庁所在市の二人以上世帯の年間室内装飾品消費支出額",
  "unit": "円",
  "category": "economy",
  "source": {
    "kind": "kakei-chousa",

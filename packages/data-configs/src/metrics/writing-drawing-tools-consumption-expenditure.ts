...
export const writingDrawingToolsConsumptionExpenditure: MetricConfig = {
  "key": "writing-drawing-tools-consumption-expenditure",
  "title": "筆記・絵画用具消費支出額",
  "subtitle": "都道府県庁所在市の二人以上世帯の年間筆記・絵画用具消費支出額",
  "unit": "円",
  "category": "economy",
  "source": {
    "kind": "kakei-chousa",

...
export const physicalTherapistAnnualIncome: MetricConfig = {
  ...
  "seoTitle": "理学療法士等の平均年収 都道府県ランキング【2022年】｜1位東京都（475.8万円）",
  "seoDescription": "2022年の理学療法士等の平均年収を都道府県別に比較。1位は東京都（475.8万円）、最下位は秋田県（347.2万円）、最大と最小の差は1.4倍です。地図やグラフで47都道府県の違いを確認できます。",
  "isActive": true,
};

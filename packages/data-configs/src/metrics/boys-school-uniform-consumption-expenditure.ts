...
export const boysSchoolUniformConsumptionExpenditure: MetricConfig = {
  "key": "boys-school-uniform-consumption-expenditure",
  "title": "男子用学校制服消費支出額",
  "subtitle": "都道府県庁所在市の二人以上世帯の年間男子用学校制服消費支出額",
  "unit": "円",
  "category": "economy",
  "source": {
    "kind": "kakei-chousa",

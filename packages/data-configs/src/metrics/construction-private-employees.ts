...
export const constructionPrivateEmployees: MetricConfig = {
  "key": "construction-private-employees",
  "title": "建設業従業者数（民営）",
  "description": "経済センサスの民営事業所のうち、建設業に分類される事業所の従業者数。事業所が所在する都道府県ごとに集計する。",

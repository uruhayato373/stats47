...
export const entertainmentRentalConsumptionExpenditure: MetricConfig = {
  "key": "entertainment-rental-consumption-expenditure",
  "title": "教養娯楽賃借料消費支出額",
  "subtitle": "都道府県庁所在市の二人以上世帯の年間教養娯楽賃借料消費支出額",
  "unit": "円",
  "category": "economy",
  "source": {
    "kind": "kakei-chousa",

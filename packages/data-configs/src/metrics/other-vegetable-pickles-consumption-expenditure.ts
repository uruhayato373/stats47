...
export const otherVegetablePicklesConsumptionExpenditure: MetricConfig = {
  "key": "other-vegetable-pickles-consumption-expenditure",
  "title": "他の野菜の漬物消費支出額",
  "subtitle": "都道府県庁所在市の二人以上世帯の年間他の野菜の漬物消費支出額",
  "unit": "円",
  "category": "economy",
  "source": {
    "kind": "kakei-chousa",

...
export const roadTunnelConditionIiiCount: MetricConfig = {
  "key": "road-tunnel-condition-iii-count",
  "title": "道路トンネルの判定区分Ⅲの施設数",
  "subtitle": "全道路管理者・施設所在地別",
  "description": "2025年度末時点の道路トンネルについて、2014〜2025年度に実施した点検の最新の健全性診断を都道府県別に集計した判定区分Ⅲの施設数。",
  ...
  "source": {
    ...
    "config": {
      "source": {
        ...
        "url": "https://www.mlit.go.jp/road/sisaku/yobohozen/pdf/r07/z2-2.pdf"
      },
      "provenance": {
        "publicationIndexUrl": "https://www.mlit.go.jp/road/sisaku/yobohozen/yobohozen_maint_r07.html",
        "pdfUrl": "https://www.mlit.go.jp/road/sisaku/yobohozen/pdf/r07/z2-2.pdf",
        "sha256": "95763e42a8bec71f62943e20fa3c10419cfab2a8d5ebae807b522e789eafc209",
        "table": "表－全トンネル2 都道府県別過年度（2014～25年度）の点検結果（全道路管理者分）",
        "pdfPage": 1,
        "valueColumn": "Ⅲ（数値第4列）",
        ...
        "verification": "47県に欠測・重複なし。47県と全国それぞれでⅠ+Ⅱ+Ⅲ+Ⅳ=診断済総数、5列全ての47県合計が全国公表値と一致。全国11,353本、Ⅲ2,990本・Ⅳ26本。",

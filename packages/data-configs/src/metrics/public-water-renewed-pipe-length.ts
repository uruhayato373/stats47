...
export const publicWaterRenewedPipeLength: MetricConfig = {
  key: 'public-water-renewed-pipe-length',
  title: '年度内に更新した水道管路延長',
  subtitle: '地方公営企業・法適用水道（上水道・簡易水道・用水供給）',
  description:
    '事業団体の所属県別に、法適用水道の年度内に更新した水道管路延長を比較します。経年化と更新の分母には同じ年度末の管路総延長を用います。',
  ...
  source: {
    ...
    config: {
      ...
      provenance: {
        ...
        formula: 'sum(列063 + 列064 + 列065)',
      },
      valueField: 'renewedKm',
    },
  },
  entities: ['prefecture'],
  years: {

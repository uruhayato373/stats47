...
export const rentalCarConsumptionExpenditure: MetricConfig = {
  "key": "rental-car-consumption-expenditure",
  "title": "レンタカー・カーシェアリング料金消費支出額",
  "subtitle": "都道府県庁所在市の二人以上世帯の年間レンタカー・カーシェアリング料金消費支出額",
  "unit": "円",
  "category": "economy",
  "source": {
    "kind": "kakei-chousa",

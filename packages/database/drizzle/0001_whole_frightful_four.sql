...
CREATE TABLE `__new_comparison_components` (
	...
	CONSTRAINT "comparison_components_component_type_check" CHECK("__new_comparison_components"."component_type" IN ('kpi-card', 'stats-card', 'bar-chart', 'line-chart', 'radar-chart', 'multi-stats-card', 'donut-chart', 'stats-table', 'stacked-area', 'bar-chart-race', 'mixed-chart', 'diverging-bar-chart', 'attribute-matrix', 'ranking-chart')),

...
describe("generateLineSvg: 長いラベルでも文字がはみ出さず重ならない", () => {
  it("★ビール月別 (12 か月 × 3 系列 + 単位 + 題名入り yLabel) の回帰", () => {
  ...
  it("25 年 × 6 系列 (長い凡例) + 1,400,000 級の値", () => {
    ...
    expectClean(
      generateFindingsCardSvg({
        findings: [
          ...
          "1世帯あたりのビール支出額は2000年から2024年の間におよそ半分になり、チューハイ・カクテルが3倍以上に増えた。",

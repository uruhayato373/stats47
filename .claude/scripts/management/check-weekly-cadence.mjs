...
// (skill reference/reviews/YYYY-Www.md) と現在計画 (docs/todo/03_今週の計画.md) は人間/agent が
...
const PLAN_FILE = resolve(PROJECT_ROOT, "docs/todo/03_今週の計画.md");
...
if (missingPlans.length) {
  ...
  for (const w of missingPlans) {
    bodyLines.push(`- [ ] \`docs/todo/03_今週の計画.md\` — \`/weekly-plan ${w}\``);
  }
  bodyLines.push("");
}
if (missingTotal === 0) {

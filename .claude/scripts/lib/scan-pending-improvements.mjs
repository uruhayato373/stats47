#!/usr/bin/env node
/**
 * docs/todo/01_改善バックログ.md のマークダウンテーブルを走査し、
 ...
 *       due: "2026-06-13",
 *       owner: "claude",
 *       deep_link: "docs/todo/01_改善バックログ.md"
 *     }
 *   ]
 */
...
const BACKLOG_PATH = path.join(PROJECT_ROOT, "docs/todo/01_改善バックログ.md");
const BACKLOG_REL = "docs/todo/01_改善バックログ.md";
...
/** 01_改善バックログ.md のマークダウンテーブルを行パースして施策一覧を返す */

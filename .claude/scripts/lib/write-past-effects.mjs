...
const SG_NOTE =
  ...
  'improvement-triage が .claude/todo/04_改善バックログ.md の effect/none|adverse エントリから維持する。' +
...
const LEDGER_SOURCE = ".claude/todo/04_改善バックログ.md の effect ラベル (writer: .claude/scripts/lib/write-past-effects.mjs)";
...
function main() {
  ...
  out.push(`# backlog: ${backlogPath ?? ".claude/todo/04_改善バックログ.md"} / entries: ${entries.length}`);
  out.push("");

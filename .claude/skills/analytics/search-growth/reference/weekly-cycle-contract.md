...
- 運用入口: `../SKILL.md`
- 未完了のCI/live確認: `docs/todo/05_機能バックログ.md` の `SEARCH-OBSERVABILITY-RELEASE-01`
- 改善サイクルの効果状態: `docs/todo/04_改善バックログ.md#SEARCH-GROWTH-CYCLE-01`
...
- 一般候補は人間承認後にだけ`docs/todo/04_改善バックログ.md`へ追加する。

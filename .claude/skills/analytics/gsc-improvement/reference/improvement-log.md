...
**Day 2-5 予約投稿完了（2026-04-18 20:40 JST）**:
Playwright で一括予約投稿成功。OGP 画像は本番ページの og:image から自動取得してローカルに配置。
| Day | 予約日時 | rankingKey | URL | UTM |
|---|---|---|---|---|
| Day 2 | 2026-04-20 21:00 | sports-spectating-consumption-expenditure | /ranking/sports-spectating-consumption-expenditure | sprint1_day2 shock |
| Day 3 | 2026-04-21 12:30 | general-hospital-bed-occupancy-rate | /socialsecurity/medical-facilities/ranking/general-hospital-bed-occupancy-rate | sprint1_day3 question |
| Day 4 | 2026-04-22 12:00 | price-index-high-low-prefecture | /blog/price-index-high-low-prefecture | sprint1_day4 question |
| Day 5 | 2026-04-23 19:30 | konbu-consumption-quantity | /ranking/konbu-consumption-quantity | sprint1_day5 paradox |

全 5 投稿 DB `sns_posts` → posted。GSC 修正検証と相乗効果で Tier 0 効果測定期間の流入底上げを狙う。

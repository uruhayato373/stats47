...
**Day 2-5 予定**:
- Day 2 (04-20 月): `/ranking/sports-spectating-consumption-expenditure` (100 倍差)
- Day 3 (04-21 火): `/ranking/general-hospital-bed-occupancy-rate` (九州集中)
- Day 4 (04-22 水): `/blog/price-index-high-low-prefecture` (物価差 7.8pt)
- Day 5 (04-23 木): `/ranking/konbu-consumption-quantity` (逆説ネタ)

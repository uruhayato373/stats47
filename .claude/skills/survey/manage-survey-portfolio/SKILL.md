...
編集ハブの実装フローは `.claude/rules/survey-content-standards.md` (1 survey ずつ実証・一括長文化禁止)。
...
npx tsx .claude/scripts/surveys/build-survey-portfolio.ts --add-experiment /tmp/exp.json

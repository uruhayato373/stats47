...
- ケバブケース: `generate-note-charts`, `export-snapshots`
- 動詞始まり: `generate-`, `fetch-`, `sync-`, `render-`, `publish-`, `validate-`, `export-`, `import-`
...
本番反映は R2 snapshot 経由（`/export-snapshots` → `/push-r2`）で行う。リモート D1 は撤廃済み（2026-04-29 Phase 10）。

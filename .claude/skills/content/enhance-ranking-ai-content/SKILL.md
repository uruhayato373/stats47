...
`.claude/todo/04_改善バックログ.md` に新 section を append (id: `AICONTENT-NNN` 連番、due は today + 28d):
...
改善ログ: .claude/todo/04_改善バックログ.md [AICONTENT-NNN]
...
- 改善バックログ: `.claude/todo/04_改善バックログ.md`
...
- [ ] `.claude/todo/04_改善バックログ.md` に `[AICONTENT-NNN]` section が append 済 (status: pending, due 4 週後)

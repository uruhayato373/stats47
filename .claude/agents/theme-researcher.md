...
1. **実行していない調査を書かない**。Read/Grep/WebFetch/e-Stat API 等を**実際に呼んだ結果だけ**を書く。
...
- 指標 table の最終行は `| self-audit | — | — | — | 未検証候補=0 | — | — |`、論点 table は
  `| self-audit | — | — | 未検証候補=0 | — |` とし、未検証候補が残る場合は 0 と偽らず全体を失敗扱いにする

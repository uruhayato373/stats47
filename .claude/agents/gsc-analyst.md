...
- `docs/05_改善ログ/gsc.md` — read only (improvement-triage が排他 write)
- `docs/05_改善ログ/indexing.md` — read only (improvement-triage が排他 write)

## File Boundary (並行衝突回避)

- `docs/05_改善ログ/{gsc,indexing}.md` への write 一切なし (improvement-triage 経由)

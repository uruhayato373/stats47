...
- ✅ done: 2154 件 (99.4% / impressions 計 73347)
- ⏳ needs-regen: 12 件 (impressions 計 0)
  - 内訳: missing 12
- 🚫 not-eligible: 0 件 — 観測値が順位として成立しないので生成しない

## 進捗 (progress-history.csv より)

- 消化ペース: **50.2 件/日** (2026-07-30 からの平均)
- 残り 12 件 → **完了見込み 約 1 日**
...
|---|---|---|---|---|
| 0 | academic-achievement-test-average-rate | missing | 🟠手動是正候補 | - |
| 0 | clothing-footwear-expenditure-total | missing | 🟠手動是正候補 | - |
| 0 | culture-recreation-expenditure-total | missing | 🟠手動是正候補 | - |
| 0 | education-expenditure-total | missing | 🟠手動是正候補 | - |
| 0 | furniture-household-expenditure-total | missing | 🟠手動是正候補 | - |
| 0 | health-medical-expenditure-total | missing | 🟠手動是正候補 | - |
| 0 | housing-expenditure-total | missing | 🟠手動是正候補 | - |
| 0 | information-communication-coefficient | missing | 🟠手動是正候補 | - |
| 0 | information-communication-expenditure | missing | 🟠手動是正候補 | - |
| 0 | other-living-expenditure-total | missing | 🟠手動是正候補 | - |
| 0 | transport-communication-expenditure-total | missing | 🟠手動是正候補 | - |
| 0 | utilities-expenditure-total | missing | 🟠手動是正候補 | - |
...
> 🟠手動是正候補は GSC 流入上位12件。自動失敗が続いた場合だけ agent で是正する。

...
- ✅ done: 2165 件 (89.9% / impressions 計 84394)
- ⏳ needs-regen: 243 件 (impressions 計 4)
  - 内訳: incomplete 1 / missing 241 / fetch-error:TypeError: fetch failed 1
- 🚫 not-eligible: 0 件 — 観測値が順位として成立しないので生成しない

## 進捗 (progress-history.csv より)

- 消化ペース: **41.0 件/日** (2026-07-30 からの平均)
- 残り 243 件 → **完了見込み 約 6 日**

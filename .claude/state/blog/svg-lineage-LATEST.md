...
棚卸し対象: 533 記事 / SVG 1420 枚

## 系譜の整備状況
- ✅ both (json+source・系譜完全): **1325** (93%)
- 🟡 jsonOnly (再生成可・出典無): **0** (0%)
- 🔴 neither (元データ消失・再生成不可): **95** (7%)
...
3. `ssot-restore-new` (33): scatter/line/findings の復元手法を新規実装
4. `manual` (40): 無意味名・型不明 → 個別手当て

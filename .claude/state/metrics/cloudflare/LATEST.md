# Cloudflare Usage — 2026-06-27

> 計測時刻: 2026-06-28T17:53:03.549Z
> 前日比: 2026-06-22
...
| 指標 | 当日 | 前日比 |
|---|---|---|
| Requests | 19.65K | ▼ -94.2% ⚠️ |
| Errors | 23 | ▼ -94.8% ✅ |
| Subrequests | 4.54K | ▼ -47.4% ✅ |

**Error rate**: 0.12% (23/19652)

## R2

| 指標 | 当日 | 前日比 |
|---|---|---|
| Class A ops (writes) | 117 | ▼ -98.5% ✅ |
| Class B ops (reads) | 72.91K | ▼ -89.7% ✅ |
| Egress | 23825MB | ▼ -79.1% ✅ |
| Storage | 19.43GB | ▲ +1.0%  |
| Objects | 51,523 | ▲ +1.4% ✅ |
...
|---|---|---|---|---|---|
| stats47 | 17.61 | 42,910 | 117 | 70.43K | 23784 |
| doboku-note | 1.82 | 8,613 | 0 | 2.48K | 41 |

# GSC カバレッジ是正 — 2026-W38 (2026-09-26)
...
- 追跡 URL: **3235** / 要対応 pending: **1003**
- URL Inspection で登録を確認して done にした URL: **100** (`--sync-inspection` が日次で更新。再び未登録と観測されたら pending に戻る)

| action | 分類総数 | pending | 意味 |
|---|---:|---:|---|
| fix-5xx | 2 | 0 | probeで5xx分類。pendingなら実バグ(最優先) |
| observe-after-fix | 1102 | 1003 | 404/5xx→現在200=生きてる→sitemap/内部リンク整備後 URL Inspection で観測 |
...
- observe-after-fix CSV: `<週>/coverage-live-observe-urls.csv` (**1003 URL**) → 修正後に url-inspection-daily.cjs で観測

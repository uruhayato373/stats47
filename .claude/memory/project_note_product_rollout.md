...
**正典**: `packages/product-factory/src/channels/note/` + `packages/product-factory/README.md`。横断チャネルの需要・商品化gateは `.claude/skills/product/build-coconala-product/reference/multi-channel-content-product-factory.md`、進捗は `.claude/todo/05_機能バックログ.md`。

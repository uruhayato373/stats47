...
32冊中22冊がKDP台帳`listed`。このうち10冊は2026-08-30にパイロット公開申請し、本棚read-back 10/10で「レビュー中」を確認した。残り10冊は需要比較用に`draft`のまま保持し、4週間の販売数・KENPを見て次の公開を判断する。ASIN未割当は審査中の正常状態として管理コンソールでwarning表示する。

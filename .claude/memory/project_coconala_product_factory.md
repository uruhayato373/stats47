...
**正典**: `docs/02_実装計画/30_ココナラ商品ファクトリー実装仕様.md`（本文は174→13の反映が残タスク）+ `packages/product-factory/README.md`。商品案の出所は `docs/04_レビュー/2026-07-18-coconala-content-monetization.md`（旧 A-01〜L-07・sourceIds でトレース）。

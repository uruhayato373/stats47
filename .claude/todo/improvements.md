...
| AFF-RANKING-RAKUTEN-NATIVE-01 | 家計調査系 ranking の本文中段 native (A8 furusato バナー) を楽天カードへ置換 — モバイル=商品軸 `rakuten-native`、デスクトップ=1位県の返礼品 `furusato-native`、右レール商品カードはデスクトップ限定。**baseline (GA4 28日 〜2026-08-28)**: 楽天商品カード ranking 右レール 424 imp / 0 click、中段 native A8 等 2,545 imp / 1 click、上段 in-content 1,477 / 1、右レール A8 等 4,169 / 2。[target: `rakuten-native`+`furusato-native` 合計 imp ≥ 2,000/28日 かつ click ≥ 1]。ローカル実装済み・未デプロイ。デプロイ後 4 週で `node .claude/scripts/ads/fetch-affiliate-ga4.cjs 28` を link_position 別に before/after。AFF-RESOLUTION-EFFECT-01 / AFF-IMPRESSION-ROUTING-01 と窓が重なる (guard: confounded)、position 別に分けて読む | pending | 2026-10-14 | claude | affiliate |

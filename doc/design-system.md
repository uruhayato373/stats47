...
|------|----------------|-----|-----|------|----------------|
| Primary | `text-gray-800` | `#1f2937` | `31, 41, 55` | 見出し・重要テキスト | 12.63:1 |
| Secondary | `text-gray-700` | `#374151` | `55, 65, 81` | 本文テキスト | 9.21:1 |
| Tertiary | `text-gray-500` | `#6b7280` | `107, 114, 128` | 補助テキスト | 4.69:1 |

/**
 * 最低賃金推移チャート表示コンポーネント（Client Component）
 */
...
interface MinimumWageTrendChartClientProps {
  /** チャート用データ */
  chartData: Array<{
    year: string;
    yearName: string;
 ...
 * 最低賃金推移チャート表示コンポーネント
 */
export function MinimumWageTrendChartClient({
  chartData,
  title,
  description,
}: MinimumWageTrendChartClientProps) {

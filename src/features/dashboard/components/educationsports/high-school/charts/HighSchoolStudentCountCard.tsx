...
interface HighSchoolStudentCountCardProps {
  /** 地域コード */
  areaCode: string;
 ...
 * 高等学校生徒数統計カード
 */
export async function HighSchoolStudentCountCard({
  areaCode,
  timeCode,
  title = "高等学校生徒数",
}: HighSchoolStudentCountCardProps) {
  try {
    // e-Stat APIから高等学校生徒数データを取得
    ...
    console.error("[HighSchoolStudentCountCard] データ取得エラー:", error);
    return (
      <Card>
        <CardHeader>
          <CardTitle>{title}</CardTitle>

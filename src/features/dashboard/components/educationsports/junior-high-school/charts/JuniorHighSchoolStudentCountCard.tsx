...
interface JuniorHighSchoolStudentCountCardProps {
  /** 地域コード */
  areaCode: string;
 ...
 * 中学校生徒数統計カード
 */
export async function JuniorHighSchoolStudentCountCard({
  areaCode,
  timeCode,
  title = "中学校生徒数",
}: JuniorHighSchoolStudentCountCardProps) {
  try {
    // e-Stat APIから中学校生徒数データを取得
    ...
    console.error("[JuniorHighSchoolStudentCountCard] データ取得エラー:", error);
    return (
      <Card>
        <CardHeader>
          <CardTitle>{title}</CardTitle>

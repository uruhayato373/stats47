...
export const FireEmergencyDashboard: React.FC<
      ...
      <div className="px-4 pt-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
          ...
          <StatisticsMetricCard
            ...
            areaCode={areaCode}
            title={isNational ? "全国消防職員数" : "消防職員数"}
            color="#dc2626"
          />
          ...
          <StatisticsMetricCard
            ...
            areaCode={areaCode}
            title={isNational ? "全国消防車両数" : "消防車両数"}
            color="#b91c1c"
          />
        </div>
      </div>

      {/* 消防・緊急事態の詳細分析（全国の場合のみ） */}
      {isNational && (

...
interface PublicAssistanceWelfareAreaPageProps {
...
export const PublicAssistanceWelfareAreaPage: React.FC<
  PublicAssistanceWelfareAreaPageProps
      ...
      <div className="px-4 pt-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          <StatisticsMetricCard
            ...
            areaCode={areaCode}
            title={`${areaName}の生活保護被保護実世帯数（月平均一般世帯千世帯当たり）`}
            color="#ef4444"
          />
          <StatisticsMetricCard
            params={{
            ...
            areaCode={areaCode}
            title={`${areaName}の生活保護被保護実人員（月平均人口千人当たり）`}
            color="#f59e0b"
          />
          <StatisticsMetricCard
            params={{
            ...
            areaCode={areaCode}
            title={`${areaName}の生活保護教育扶助人員（月平均人口千人当たり）`}
            color="#10b981"
          />
          <StatisticsMetricCard
            params={{
            ...
            areaCode={areaCode}
            title={`${areaName}の生活保護医療扶助人員（月平均人口千人当たり）`}
            color="#3b82f6"
          />
          <StatisticsMetricCard
            params={{
            ...
            areaCode={areaCode}
            title={`${areaName}の生活保護住宅扶助人員（月平均人口千人当たり）`}
            color="#8b5cf6"
          />
          <StatisticsMetricCard
            params={{
            ...
            areaCode={areaCode}
            title={`${areaName}の生活保護介護扶助人員（月平均人口千人当たり）`}
            color="#ec4899"
          />
          <StatisticsMetricCard
            params={{
            ...
            areaCode={areaCode}
            title={`${areaName}の生活保護被保護高齢者数（月平均65歳以上人口千人当たり）`}
            color="#f97316"
          />
          <StatisticsMetricCard
            params={{
            ...
            areaCode={areaCode}
            title={`${areaName}の身体障害者手帳交付数（人口千人当たり）`}
            color="#06b6d4"
          />
        </div>
      </div>

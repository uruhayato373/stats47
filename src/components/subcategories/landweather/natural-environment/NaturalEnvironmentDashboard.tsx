...
export const NaturalEnvironmentDashboard: React.FC<
      ...
      <div className="px-4 pt-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
          ...
          <StatisticsMetricCard
            ...
            areaCode={areaCode}
            title={isNational ? "全国都道府県立自然公園" : "都道府県立自然公園"}
            color="#0d9488"
          />
          ...
          <StatisticsMetricCard
            ...
            areaCode={areaCode}
            title={isNational ? "全国天然記念物" : "天然記念物"}
            color="#047857"
          />
        </div>
      </div>

...
export const InfrastructureEnergyDashboard: React.FC<
      ...
      <div className="px-4 pt-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
          ...
          <StatisticsMetricCard
            ...
            areaCode={areaCode}
            title={isNational ? "全国電力供給量" : "電力供給量"}
            color="#0891b2"
          />
          ...
          <StatisticsMetricCard
            ...
            areaCode={areaCode}
            title={isNational ? "全国ガス供給量" : "ガス供給量"}
            color="#0e7490"
          />
          ...
          <StatisticsMetricCard
            ...
            areaCode={areaCode}
            title={isNational ? "全国再生可能エネルギー" : "再生可能エネルギー"}
            color="#155e75"
          />
        </div>
      </div>

      {/* インフラ・エネルギーの詳細分析（全国の場合のみ） */}
      {isNational && (

...
export const SocialActivitiesDashboard: React.FC<
      ...
      <div className="px-4 pt-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
          ...
          <StatisticsMetricCard
            ...
            areaCode={areaCode}
            title={
              isNational ? "全国ボランティア活動者数" : "ボランティア活動者数"
            }
            color="#eab308"
          />
          ...
          <StatisticsMetricCard
            ...
            areaCode={areaCode}
            title={isNational ? "全国クラブ・サークル数" : "クラブ・サークル数"}
            color="#ca8a04"
          />
          ...
          <StatisticsMetricCard
            ...
            areaCode={areaCode}
            title={isNational ? "全国イベント開催数" : "イベント開催数"}
            color="#a16207"
          />
        </div>
      </div>

...
const meta: Meta<typeof EstatDataDisplay> = {
  title: "Estat/EstatDataDisplay",
  component: EstatDataDisplay,
  parameters: {
    layout: "padded",
    docs: {
      description: {
        component:
          "e-Stat APIのレスポンスデータを表示するメインコンポーネントです。タブ形式で概要、カテゴリ、地域、年度、値、Raw JSONを表示します。",
      },
    },
  },
  argTypes: {
...
export default meta;
type Story = StoryObj<typeof EstatDataDisplay>;
...
// エラー状態のデータ
export const DataWithError: Story = {
  args: {
    data: {
      GET_STATS_DATA: {
        RESULT: {

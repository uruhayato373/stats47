...
const meta: Meta<typeof EstatRawData> = {
  title: "Estat/EstatRawData",
  component: EstatRawData,
  parameters: {
    layout: "padded",
    docs: {
      description: {
        component:
          "e-Stat APIのレスポンスデータをJSON形式で表示するコンポーネントです。コピーボタンでJSONデータをクリップボードにコピーできます。",
      },
    },
  },
  argTypes: {
...
export default meta;
type Story = StoryObj<typeof EstatRawData>;

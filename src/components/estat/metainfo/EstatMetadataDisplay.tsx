...
export default function EstatMetadataDisplay() {
  ...
  const toggleExpanded = (statsDataId: string) => {
    const newExpanded = new Set(expandedItems);
    if (newExpanded.has(statsDataId)) {
      newExpanded.delete(statsDataId);
    } else {
      newExpanded.add(statsDataId);
    }
          ...
          <div className="space-y-3">
            {currentData.map((item, index) => {
              ...
              return (
                ...
                >
                  <button
                    onClick={() => toggleExpanded(item.stats_data_id)}
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2 text-gray-500">
                        ...
                        {expandedItems.has(item.stats_data_id) ? (

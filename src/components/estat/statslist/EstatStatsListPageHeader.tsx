import { RefreshCw, List, ExternalLink } from "lucide-react";

interface EstatStatsListPageHeaderProps {
  loading: boolean;
  currentQuery: string;
  onRefresh: () => void;
}

export default function EstatStatsListPageHeader({
  loading,
  currentQuery,
  onRefresh,
}: EstatStatsListPageHeaderProps) {
  return (

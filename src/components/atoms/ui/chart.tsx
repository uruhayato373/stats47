              ...
              <div key={key} className="flex items-center gap-2 text-sm">
                {!hideIndicator && (
                  <div
                    ...
                    style={{
                      backgroundColor:
                        indicator === "dot" ? item.color : undefined,
...
const ChartLegendContent = React.forwardRef<
  ...
  React.ComponentProps<"div"> & {
    ...
    nameKey?: string;
    hideIcon?: boolean;
    // Recharts Legend から渡される props（DOM 要素に渡さない）
    iconSize?: number;
...
>(
  (
    ...
    // Recharts Legend から渡される props を除外（DOM 要素に渡さない）
    void _iconSize;
    void _verticalAlign;
    void _chartWidth;
    void _chartHeight;
    ...
    return (
      ...
      >
        {payload.map((item) => {
          ...
          return (
            <div key={item.value} className="flex items-center gap-1.5 text-sm">
              {!hideIcon && (
                <div

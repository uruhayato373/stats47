  ...
  return (
    <div className="p-4 flex flex-col bg-white border-b border-gray-200 dark:bg-neutral-800 dark:border-neutral-700">
      <div className="pb-2 flex flex-wrap justify-between items-center gap-2 border-b border-dashed border-gray-200 dark:border-neutral-700">
        <h2 className="font-medium text-gray-800 dark:text-neutral-200">Analytics</h2>
      ...
      <div className="mt-2 grid grid-cols-2 gap-2">
        <div className="flex flex-col">
          <span className="block font-medium text-xl text-gray-800 dark:text-neutral-200">22,900</span>
        ...
        <div className="flex flex-col">
          <span className="block font-medium text-xl text-gray-800 dark:text-neutral-200">8,430</span>

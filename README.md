...
- **共通 UI コンポーネント**: 再利用可能な Message、DataTable、InputField コンポーネント
- **EstatDataDisplay コンポーネント群**: e-Stat API データ表示用の包括的なコンポーネント群
...
│   │   │   └── EstatDataDisplay/    # メインデータ表示コンポーネント群
│   │   │       ├── EstatDataDisplay.tsx
│   │   │       ├── components/      # サブコンポーネント群
│   │   │       │   ├── EstatOverview/
│   │   │       │   ├── EstatCategoriesTable/
│   │   │       │   ├── EstatAreasTable/
│   │   │       │   ├── EstatYearsTable/
│   │   │       │   ├── EstatValuesTable/
│   │   │       │   └── EstatRawData/
...
│   ├── contexts/           # React Context（レガシー）
│   ├── providers/          # プロバイダー（JotaiProvider）
│   ├── hooks/              # カスタムフック

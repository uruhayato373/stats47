...
interface AgriculturalHouseholdCountCardProps {
  /** 地域コード */
  areaCode: string;
 ...
 * 農業世帯数統計カード
 */
export async function AgriculturalHouseholdCountCard({
  areaCode,
  timeCode,
  title = "農家数",
}: AgriculturalHouseholdCountCardProps) {
  try {
    // e-Stat APIから農家数データを取得
    ...
    console.error(
      "[AgriculturalHouseholdCountCard] データ取得エラー:",
      error
    );
    return (
      <Card>

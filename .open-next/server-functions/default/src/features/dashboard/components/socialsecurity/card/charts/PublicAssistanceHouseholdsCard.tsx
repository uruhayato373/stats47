...
interface PublicAssistanceHouseholdsCardProps {
  /** 地域コード */
  areaCode: string;
 ...
 * 生活保護被保護実世帯数統計カード
 */
export async function PublicAssistanceHouseholdsCard({
  areaCode,
  timeCode,
  title = "生活保護被保護実世帯数",
}: PublicAssistanceHouseholdsCardProps) {
  try {
    // e-Stat APIから生活保護被保護実世帯数データを取得
    ...
    console.error(
      "[PublicAssistanceHouseholdsCard] データ取得エラー:",
      error
    );
    return (
      <Card>

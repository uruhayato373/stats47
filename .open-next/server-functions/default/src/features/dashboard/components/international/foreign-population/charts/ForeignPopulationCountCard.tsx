...
interface ForeignPopulationCountCardProps {
  /** 地域コード */
  areaCode: string;
 ...
 * 外国人人口統計カード
 */
export async function ForeignPopulationCountCard({
  areaCode,
  timeCode,
  title = "外国人人口",
}: ForeignPopulationCountCardProps) {
  try {
    // e-Stat APIから外国人人口データを取得
    ...
    console.error("[ForeignPopulationCountCard] データ取得エラー:", error);
    return (
      <Card>
        <CardHeader>
          <CardTitle>{title}</CardTitle>

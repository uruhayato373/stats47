...
const SURVEY_EDITORIAL_CONTENT = {
  ...
  'port-statistics': {
    ...
    readerQuestions: [
      ...
      { question: '港湾調査の対象港数が多い都道府県は？', rankingKey: 'port-count' },
    ],
    caveats: [
      ...
      '対象港数は2025年1月1日施行版の規則別表から集計した指定数で、全国の全港湾数ではありません。共同港の境港は国土交通省の掲載区分に従い鳥取県へ一度だけ計上しています。',
    ],
  },
  ...
  'population-projection': {
    summary:
      '日本の地域別将来推計人口は、国立社会保障・人口問題研究所が2020年国勢調査を基準に、都道府県・市区町村の将来人口を5年ごとに2050年まで推計したものです。このハブでは、令和5年推計による2050年の都道府県別人口と、2020年から2050年への人口増減率を比較できます。',
    whatYouCanLearn: [
      '2050年の推計人口が多い都道府県',
      '2020年から2050年への人口増減率の地域差',
      '人口規模と増減率で異なる都道府県の位置づけ',
    ],
    readerQuestions: [
      {
        question: '2050年の推計人口が多い都道府県は？',
        rankingKey: 'future-population',
      },
      {
        question: '2020年から2050年への人口増減率は都道府県でどう違う？',
        rankingKey: 'future-population-change-rate-2050',
      },
    ],
    caveats: [
      '将来推計は予測値であり、実績値ではありません。出生、死亡、人口移動に一定の仮定を置いた結果なので、政策や社会状況の変化によって実際の人口は異なります。',
      '地域別推計は市区町村別の推計を合計して都道府県値を得ています。地域別の推計期間は2050年までで、全国推計の2070年までの結果とは掲載期間が異なります。',
      '2020年値は年齢・国籍などの不詳を補完した基準人口を用いるため、国勢調査の公表値と一致しない場合があります。',
      '掲載ランキングの2050年は推計対象年で、推計が公表された2023年とは異なります。人口増減率は2020年を基準とする30年間の変化で、1年間の増減率ではありません。',
    ],
  },
  ...
  'mlit-ksj': {
    summary:
      '国土数値情報は、国土交通省が整備する国土に関する地理空間情報です。空港、鉄道駅、湖沼などの位置情報を都道府県別に集計し、地形やインフラの地域差を比較できます。',
    whatYouCanLearn: [
      '湖沼など地形と水系に関わる分布',
      '空港・鉄道駅といった交通拠点の地域差',
    ...
    caveats: [
      ...
      '件数は規模を表しません。駅1つあたりの乗降客数は、この指標からは分かりません。',
      '非商用条件のデータを用いた旧ランキングは公開を終了しました。道の駅・漁港・港湾調査の対象港数の現行ランキングは別の公式資料に切り替えており、この調査の系列には含めません。',
    ],
  },

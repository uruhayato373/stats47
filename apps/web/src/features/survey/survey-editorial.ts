...
const SURVEY_EDITORIAL_CONTENT = {
  ...
  'patient-survey': {
    ...
    readerQuestions: [
      ...
      {
        question: '年齢別の受療率は都道府県でどう違う？',
        rankingKey: 'patient-receiving-rate-by-age',
      },
    ],
    caveats: [
  ...
  'construction-orders-statistics': {
    ...
    readerQuestions: [
      {
        question: '公共建設工事の請負契約額が大きい都道府県は？',
        rankingKey: 'construction-contract-total',
      },
      {
        question: '道路工事の請負契約額が大きい都道府県は？',
        rankingKey: 'construction-contract-road',
      },
      {
        question: '災害復旧工事の請負契約額が大きい都道府県は？',
        rankingKey: 'construction-contract-disaster-recovery',
      },
      {
        question: '公共建設工事の件数が多い都道府県は？',
        rankingKey: 'construction-projects-total',
      },
    ],
    caveats: [

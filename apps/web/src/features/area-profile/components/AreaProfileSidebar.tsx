 ...
 * なっていた。以前は PageShell も右レールを desktop / mobile の2箇所へ複製していたため、
 * 件数制限に加えて PageShell 側を単一DOMへ統合し、同名指標も1件へまとめる。
 */
...
function RankingCard({ title, items, icon, titleClassName }: RankingCardProps) {
...
export function AreaProfileSidebar({
  strengths,
  weaknesses,
}: AreaProfileSidebarProps) {
  return (

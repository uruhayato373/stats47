...
function TermsArticle({
  ...
  return (
    <SurfaceCard>
      <div className="py-3 px-4 flex flex-row items-center gap-2 space-y-0 border-b border-border">
        <h2 className="text-base font-semibold leading-none text-xl">{title}</h2>
      </div>
  ...
  return (
    <PageShell variant="reading">
      ...
      <div className="space-y-6">
        ...
        {/* 第3条（利用規約の変更） */}
        <TermsArticle title="第3条（利用規約の変更）">
          <p className="text-sm leading-relaxed text-muted-foreground">
        ...
        {/* 第4条（サービスの内容） */}
        <TermsArticle title="第4条（サービスの内容）">
          <div className="space-y-4">
            <p className="text-sm leading-relaxed text-muted-foreground">
        ...
        {/* 第9条（サービスの中断・停止） */}
        <TermsArticle title="第9条（サービスの中断・停止）">
          <div className="space-y-4">
            <p className="text-sm leading-relaxed text-muted-foreground">
        ...
        {/* 第10条（準拠法・管轄裁判所） */}
        <TermsArticle title="第10条（準拠法・管轄裁判所）">
          <div className="space-y-4">
            <p className="text-sm leading-relaxed text-muted-foreground">
              本規約は、日本法を準拠法とします。
            </p>
        ...
        {/* 第11条（お問い合わせ） */}
        <TermsArticle title="第11条（お問い合わせ）">
          <p className="text-sm leading-relaxed mb-4 text-muted-foreground">

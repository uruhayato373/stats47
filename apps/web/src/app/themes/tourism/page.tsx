...
import { ThemePageLayout, loadThemeData, TOURISM_THEME } from "@/features/theme-dashboard/server";
...
export default async function TourismThemePage() {

...
import { ThemePageLayout, loadThemeData, REAL_INCOME_THEME } from "@/features/theme-dashboard/server";
...
export default async function RealIncomeThemePage() {

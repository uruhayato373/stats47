...
import { ThemePageLayout, loadThemeData, AGING_SOCIETY_THEME } from "@/features/theme-dashboard/server";
...
const theme = AGING_SOCIETY_THEME;
...
export default async function AgingSocietyThemePage() {

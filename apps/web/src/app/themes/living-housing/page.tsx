...
import { ThemePageLayout, loadThemeData, LIVING_HOUSING_THEME } from "@/features/theme-dashboard/server";
...
const theme = LIVING_HOUSING_THEME;
...
export default async function LivingHousingThemePage() {

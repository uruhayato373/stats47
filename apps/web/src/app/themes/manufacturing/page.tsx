...
import { ThemePageLayout, loadThemeData, MANUFACTURING_THEME } from "@/features/theme-dashboard/server";
...
const theme = MANUFACTURING_THEME;
...
export default async function ManufacturingThemePage() {

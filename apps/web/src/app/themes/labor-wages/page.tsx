...
import { ThemePageLayout, loadThemeData, LABOR_WAGES_THEME } from "@/features/theme-dashboard/server";
...
export default async function LaborWagesThemePage() {

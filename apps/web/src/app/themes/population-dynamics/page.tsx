...
import { ThemePageLayout, loadThemeData, POPULATION_DYNAMICS_THEME } from "@/features/theme-dashboard/server";
...
const theme = POPULATION_DYNAMICS_THEME;
...
export default async function PopulationDynamicsThemePage() {

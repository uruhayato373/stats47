...
export function buildRankingThumbnailElement(
  ...
  return h(
    ...
    h(
      ...
      h("div", { style: { display: "flex", color: muted, fontSize: 14 } }, "1位"),
      h("div", { style: { display: "flex", fontSize: 22, fontWeight: 800 } }, data.topAreaName),
      h(
        "div",
        { style: { display: "flex", alignItems: "baseline", color: primary, marginTop: 4 } },
        h("span", { style: { fontSize: 30, fontWeight: 900 } }, data.topValue),
        h("span", { style: { fontSize: 13, fontWeight: 700, marginLeft: 4 } }, data.unit),
      ),
    ),
    h(
      "div",

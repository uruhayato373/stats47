 ...
 *
 * CI ビルド環境は D1 binding が無いため、generateStaticParams / middleware はこのファイルを参照する。
 *
 ...
 *
 * CI ビルド環境（GitHub Actions の Deploy to Cloudflare Workers）では D1 binding が
 * 使えないため、generateStaticParams と middleware はこのファイルを参照する。
 *

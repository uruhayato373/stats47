...
/** 3枚目: まとめ。何項目中どちらの数値が大きかったかを並べる (良し悪しの勝敗ではない) */
export const CompareSummarySlide: React.FC<CompareSummarySlideProps> = ({ data }) => {
  const { summary, items } = data;
  return (
    <IgSeriesFrame series={SERIES} tag="比べた結果" swipeLabel="保存はこちら" sourceLabel="出典は各項目に記載">
      ...
      <IgSeriesCard style={{ marginTop: 36, padding: "44px 32px", display: "flex", alignItems: "center", justifyContent: "space-around" }}>
        <div style={{ textAlign: "center" }}>
          ...
          <div style={{ fontSize: 24, fontWeight: IG_FONT.weight.bold, color: "#64748B" }}>項目で大きい</div>
        </div>

...
```typescript
// src/infrastructure/mlit-dpf-api/client/mlit-dpf-client.ts
...
```typescript
// src/infrastructure/weather-api/client/jma-client.ts
...
```typescript
// src/infrastructure/mlit-dpf-api/types/index.ts
...
```typescript
// src/infrastructure/weather-api/types/weather.ts
...
import { resasClient } from "@/infrastructure/resas-api/client/resas-client";
...
import { NextRequest, NextResponse } from "next/server";
import { jmaWeatherClient } from "@/infrastructure/weather-api/client/jma-client";

...
まず全体像を押さえる。上位は埼玉県（38.0%）、神奈川県（36.9%）、千葉県（36.5%）、茨城県（25.8%）、奈良県（25.6%）と、首都圏・近畿圏のベッドタウンが並ぶ。一方、下位は鳥取県（2.8%）、沖縄県（2.9%）、島根県（3.0%）と続く。全国平均は10.9%で、上位と下位の開きは約13.6倍に達する。分布の中位（24位前後）は広島県の7.3％で、上位・下位の極端さに比べ、多くの県は中央付近に集まっている。上位の首都圏3県だけが突出して高く、それ以外の大多数の県では長時間通勤はむしろ少数派だ。つまり長時間通勤は日本全体の宿命ではなく、特定地域の住まい方が生む偏った負担だといえる。裏を返せば、長時間通勤に苦しむ世帯は首都圏という特定地域に偏って集中している。その地域に住みながら通勤負担だけを外せるなら、得られる時間の価値は大きい。
...
通勤時間は、毎日ほぼ強制的に発生する時間的な固定費だと捉えると、その重さが見えてくる。片道90分なら往復で1日3時間、月に20日通えば60時間、年間では700時間を超える。これは数週間分の労働時間に匹敵し、それが数十年続くと考えれば、失う時間は膨大だ。多くの世帯はこの固定費を、都心の高い住居費を避けるための代償として受け入れてきた。だがリモートワークは、住居費と通勤時間というこれまでトレードオフだった二つを同時に解く。通勤を固定費として明示的に勘定に入れれば、働き方を変えることが、見えにくいが極めて大きなリターンを生む投資だと分かる。この固定費を黙って払い続けるのか、働き方を変えて取り戻すのか——その判断は、年収の数字と同じくらい、いや見えにくいぶんそれ以上に、人生の質を左右する。

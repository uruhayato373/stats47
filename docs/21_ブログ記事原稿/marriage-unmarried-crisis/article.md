...
「少子化の原因は未婚化・晩婚化」とよく言われる。だが47都道府県のデータを見ると、その関係はシンプルではない。
...
**都市集中型（東京・大阪・愛知）**: 婚姻率は高いが晩婚で出生率が低い。若者が集まるため婚姻件数は多いが、生活コストの高さが出産を抑制する。東京は婚姻率1位・出生率47位という両極端。

**地方バランス型（沖縄・宮崎・佐賀・島根）**: 婚姻率は中位以上で出生率も高い。初婚年齢が比較的若く、地域コミュニティの子育て支援が厚い。「結婚しやすく、産みやすい」環境が整っている。

**過疎化進行型（秋田・岩手・青森・山形）**: 婚姻率・出生率ともに低い。若年人口の流出で「結婚相手がいない」構造的問題を抱える。未婚率が低く見えるのは高齢者比率が高いだけで、「婚姻率最下位」という現実が示す通り深刻な状況。

**ベッドタウン型（埼玉・千葉・神奈川）**: 婚姻率・出生率ともに中位だが晩婚傾向が強い。東京への通勤圏として若い世帯が流入するが、住宅費や通勤時間が出産の障壁となる。

...
> [!NOTE]
> この図の各県別の値は、長野県とその1県だけの間で成立した純移動です。後段で紹介する転入・転出の推移グラフは、長野県が全国のすべての県との間でやり取りした合計であり、規模がまったく異なります。1県あたりの値と全国合計の値を混同しないよう注意してください。
...
> [!WARNING]
> このデータは都道府県間の移動だけを対象としており、長野県内の市町村間の移動や、海外との出入国は含まれていません。長野県内での引っ越しがどれだけ多くても、この統計には一切反映されない点に注意してください。

...
seoTitle: "焼肉消費支出額1位は高知21,768円・最下位兵庫3,943円｜大都市ほど低い5.5倍格差 47都道府県2024"
...
焼肉消費支出額（都道府県庁所在市の二人以上世帯の年間支出）の1位は**高知の21,768円**。2位の大分（15,270円）を6,000円以上引き離す独走だ。一方、最下位は意外にも**兵庫の3,943円**。1位と最下位の差は実に**5.52倍**にのぼる。47都道府県の平均は9,277円、中央値は8,889円なので、高知は平均の2.3倍を外食ならぬ「家での焼肉」に投じている計算になる。
...
<chart-placeholder type="bar" data="yakiniku-spending-prefecture-gap-top10" caption="焼肉消費支出額 上位10県と最下位3県（2024年・円）" />
...
最下位は兵庫の3,943円。トップの高知（21,768円）と比べると5.52倍の開きがあり、47都道府県のなかで唯一4,000円を割り込んでいる。続く新潟（5,237円）、沖縄（5,277円）も5,000円台前半と、上位勢の半分以下だ。
...
総務省統計局「家計調査」（品目別支出・都道府県庁所在市・二人以上世帯、2024年）。本記事の数値は e-Stat（政府統計の総合窓口）経由で整備したデータに基づく。焼肉消費支出額は1世帯あたりの年間金額（単位：円）で、県庁所在市の値である。

### 関連ランキング

- [焼肉消費支出額ランキング](https://stats47.jp/ranking/yakiniku-consumption-expenditure)
- [経済カテゴリのランキング一覧](https://stats47.jp/category/economy)
- [高知県のデータプロフィール](https://stats47.jp/areas/39000)
- [兵庫県のデータプロフィール](https://stats47.jp/areas/28000)

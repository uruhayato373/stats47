...
この記事では、焼肉に最も金を使う県・使わない県を順位ごとに並べ、「西日本が上位に固まる一方、近畿の大都市が下位に沈む」という意外な構造を読み解いていきます。支出額に潜むのは、味の好みだけでなく「外食 vs 家庭」という消費スタイルの県民性です。
...
なぜここまで開くのでしょうか。上位の高知・大分・岡山・熊本・香川は、いずれも人口規模が中規模以下の地方都市を県庁所在市に持ちます。焼肉専門店の密度が大都市より低く、家庭やまとまった集まりで肉を焼く機会が相対的に多いと考えられます。家計調査が捉えるのは「家庭内の食材支出」なので、外食より家での焼肉に比重がある県ほど数値が高く出やすい、という関係が読み取れます。
...
上位を見ると、高知・大分・岡山・熊本・香川・鹿児島と、人口規模が中規模以下の西日本の県が並びます。これらの県は焼肉専門店の密度が大都市より低く、家庭やまとまった集まりで肉を焼く機会が相対的に多いと考えられます。家計調査が捉える「家庭内支出」が高く出るのは自然な結果です。

一方、下位には兵庫（47位）・大阪（28位）・京都（38位）・東京（34位、8,019円）といった大都市圏が沈みます。焼肉店が街にあふれる都市部では、「焼肉は外で食べるもの」になりやすく、家庭での食材支出が抑えられます。

> [!NOTE]
> [仮説] 「上位＝家庭焼肉文化が強い県、下位＝外食焼肉が主流の都市圏」という解釈は、本データ（家庭内支出）と都市構造の対比から導いた推測であり、外食支出データとの突き合わせによる検証が必要。家計調査の外食「焼肉」項目や、人口密度・飲食店密度との相関分析で確かめるべき論点。
...
逆に、黒毛和牛の産地として有名な鹿児島は9位（10,405円）と上位ながら突出はせず、宮崎は20位（9,088円）、長崎にいたっては44位（6,440円）と下位でした。「ブランド牛の産地＝焼肉支出が高い」という直感は、必ずしも家庭内支出には当てはまりません。産地であることと、家庭でどれだけ焼肉に支出するかは別の話なのです。

> [!TIP]
> 焼肉支出を「家計のなかでどれだけ食に振り向けているか」の手がかりとして読むなら、外食を含む食料費全体や、肉類・調味料といった関連品目とあわせて見ると解像度が上がります。家庭内支出だけを見て県民の焼肉好きを断じないのが、この種のデータを読むコツです。
...
- 上位は高知・大分・岡山・熊本・香川・鹿児島など**西日本の中規模県**が目立ち、下位は兵庫・京都・大阪・東京など**大都市圏**が沈む傾向。

...
対する下位5県には、はっきりした地域の偏りがあります。最下位の青森県（2,598円）と岩手県（2,644円）はともに東北で、鳥取県（2,745円）・島根県（2,873円・42位）の山陰、そして長崎県（2,747円）が並びます。寒冷で水分補給の需要が比較的小さく、良質な地下水・湧水に恵まれた地域では、わざわざ水を買う必要が薄れるためと読めます。図の青と橙のバーの長さの差が、そのまま「水にお金を使う県」と「使わない県」の落差を表しています。

...
**補足:** この記事のケーキ消費支出額は、家計調査における1世帯当たりの年間支出額を都道府県別に集計したもので、購入頻度や単価の違いは反映されていません。世帯人数や年齢構成が異なる都道府県間の単純比較には注意が必要です。

> [!WARNING]
> 家計調査は調査対象となる世帯数が都道府県ごとに限られているため、都市部に比べて人口の少ない県ではサンプル数が少なく、年による変動が大きくなりやすい点に留意が必要です。この記事のデータは2024年の単年の値であり、複数年の平均とは異なります。

**読み解きのポイント:** ケーキの支出額だけでは、その地域で洋菓子が好まれているのかどうかは判断できません。和菓子など他の菓子の支出額と並べて初めて、菓子全体の中でのケーキの位置づけが見えてきます。

...
![チャート](data/udon-soba-food-culture-prefecture-map-prefecture-rankings.svg)
...
ここで本記事の核心、下位グループを見てみよう。最も少ないのは沖縄県（4,378g）。沖縄は独自のソーキそば（中華麺系）文化を持つが、家計調査の「生うどん・そば」の購入量としては突出して少ない。

...
まず全体像を押さえる。上位は秋田県（952.5万円）、奈良県（884.9万円）、千葉県（812.6万円）、神奈川県（790.7万円）、広島県（786.4万円）。一方、下位は沖縄県（359.1万円）、山形県（418.2万円）、佐賀県（434.2万円）と続く。全国平均は612.0万円で、上位と下位では約2.6倍の差がある。

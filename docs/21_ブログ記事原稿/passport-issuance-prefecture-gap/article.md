...
seoTitle: "パスポート発行件数1位は東京50.9件・最下位秋田10.3件｜4.9倍の差 47都道府県2024年度"
...
2024年度の1位は **[東京都](/areas/13000)の50.9件**。一方で最下位の **[秋田県](/areas/05000)はわずか10.3件** で、その差は約 **4.9倍** に開く。同じ日本に住みながら、海外へのパスポートを手にする頻度がこれほど違うのはなぜか。
...
![人口千人あたり一般旅券発行件数 上位10県・下位5県（2024年度）](data/passport-issuance-prefecture-gap-prefecture-rankings.svg)
...
下位5県（上のチャート右側）を抜き出すと、地理的な偏りがはっきりする。山形・福島がともに14.0件（43位）、岩手11.3件（45位）、青森10.6件（46位）、そして最下位の秋田10.3件（47位）——**この5県すべてが東北** だ。下位の常連はおおむね、(1) 国際空港から遠く海外渡航の物理的ハードルが高い、(2) 人口減少・高齢化が進み若年層が薄い、(3) 一人あたり所得が相対的に低い、という条件が重なる地域である。

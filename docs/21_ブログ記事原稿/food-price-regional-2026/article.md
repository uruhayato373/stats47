...
価格を横軸（食料価格地域差指数）、食料費割合を縦軸にとって47都道府県を散布図に並べると、圧迫の原因の違いがはっきりします。点線は全国平均（価格100・比率27.7%）で、図を4象限に分けています。

![価格指数×食料費比率の散布図](data/food-quadrant-scatter.svg)

図を見ると、点は右肩上がりの帯にはなりません。**価格が高い県ほど食料費割合も高い、という単純な関係は成立していない**のがこの散布図の要点です。

**右上の「価格高×比率高（最圧迫）」象限には沖縄・東京・京都**が並びます。なかでも沖縄（価格106.7・比率29.4%）は右端で突出し、価格・比率の両面で最圧迫象限を独走しています。東京は図の右側、比率の平均線付近に位置し、食料価格は2位（103.0）なのに食料費割合は15位（28.5%）どまりで、**横軸（価格）に引っ張られた価格主導の圧迫**だと読み取れます。

兵庫（価格100.0・比率31.8%）は図の縦中央の点線上、つまり**横軸では平均ちょうど**に立ちながら、**縦軸は最上段**まで突き抜けています。大阪（価格99.5・比率31.5%）も同様に左寄りの最上段に位置し、両県とも価格は平均並みなのに食費比率の高さだけで上方へ押し上げられた**比率主導の圧迫**型だとわかります。沖縄と兵庫が散布図上でまったく別の方向に飛び出していることが、両県の圧迫の正体の違いを視覚的に裏づけています。

左下の「価格安×比率低（最緩和）」象限には**栃木（価格98.0・比率25.2%）・長野（価格95.8・比率25.8%）・茨城（価格97.4・比率25.4%）**が左下隅に固まり、食品インフレに対するレジリエンスが高い県群を形成しています。価格が安く、家計に占める食料費の比率も低いため、値上げの波が相対的に届きにくい構造です。

> [!WARNING]
> この散布図は価格と比率の2指標を同じ図に重ねたものであり、**価格が比率を引き起こす（あるいはその逆）という因果を示すものではありません**。圧迫指数も2指標の積であって相関構造を内包するため、上位県の並びは「価格と比率がたまたま同居した結果」です。相関と因果を取り違えず、価格主導か比率主導かは県ごとに個別に読んでください。

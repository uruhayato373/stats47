...
水泳は屋内外どちらでも行える他のスポーツと違い、必ず専用のプールという設備を必要とする点が特徴です。ジョギングやウォーキングであれば道路や公園さえあれば始められますが、水泳は近隣に施設がなければ選択肢にすら入りません。この設備依存の強さが、都市部と地方部で行動者率が大きく分かれる背景になっていると考えられます。

同時に、長野県や高知県のような非都市圏の県が上位に入っている事実は、施設さえ整えば地方でも行動者率を伸ばせる可能性を示しています。学校教育で水泳指導を重視する、公営プールの利用料を抑える、海水浴場へのアクセスを整えるといった取り組みは、都市部の民間施設に頼らずとも行動者率を押し上げる余地を残していると読み取れます。

...
山形県と香川県を指標ごとに比べると、麺の「型」の違いがはっきりします。

- 中華そば（ラーメン）外食支出: 山形県は**1位**（22,389円）、香川県は28位（7,908円）。
- 日本そば・うどん外食支出: 山形県は**2位**（12,795円）、香川県は**1位**（16,156円）。
- 生うどん・そば消費量: 山形県は11位（11,453）、香川県は**1位**（16,788）。

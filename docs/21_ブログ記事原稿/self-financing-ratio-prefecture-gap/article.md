...
seoTitle: "自主財源比率1位は東京89.1%・最下位高知25.7%｜なぜ34県は国頼みか 47都道府県2022"
subtitle: "なぜ34県は歳入の半分を国に頼るのか"
slug: self-financing-ratio-prefecture-gap
description: "「同じ47都道府県でも、自前で55%以上を稼げるのは10県だけ」──総務省2022年度の自主財源比率で、東京は89.1%だが高知は25.7%。1位と最下位で3.5倍。なぜ大半の県が国の交付税に頼るのか、その地理を可視化します。"
archetype: A
...
「自分たちの街は、自分たちのお金で運営できているのか」──そう問われたとき、胸を張って「はい」と答えられる都道府県は、実はごくわずかです。総務省「地方財政状況調査」の 2022 年度版を見ると、歳入の 55% 以上を自前で賄える県は **47 のうち 10 県だけ**。歳入の半分（50%）を超える県まで広げても 13 県にとどまり、残り 34 県は収入の半分超を国からの再分配に頼っています。
...
自主財源比率を 50% で線引きすると、これを超えるのは 13 県です。上から東京・神奈川・大阪・愛知・千葉・兵庫・福岡・宮城・栃木・群馬・埼玉・茨城・京都が並び、三大都市圏に福岡（地方の経済中心）、仙台を抱える宮城、北関東の工業地帯を持つ栃木・群馬・茨城が加わる構図です。これらの県には、人口集積か産業集積のどちらか、あるいは両方があります。

ただし「半分」を少し上回るだけの県と、余裕をもって自立している県には差があります。比率が 55% を超えるのは上位 10 県（東京〜群馬）に絞られ、埼玉（54.5%）・茨城（52.4%）・京都（50.9%）の 3 県は 50% 台の前半にとどまります。埼玉は東京の通勤圏として人口は多いものの、企業の本社は隣接する東京に集中するため法人税収が伸びにくく、京都も大学・観光が中心で大規模な製造業の集積が薄いことが、ぎりぎり 50% を越える水準に表れています。「自前で半分以上」と言えても、その内実は県ごとにかなり違うのです。

境界線を越える県の理由は、必ずしも人口の多さだけではありません。8〜10 位の宮城・栃木・群馬を見ると、宮城は東北の中枢である仙台に人と企業が集まり、栃木・群馬は自動車・電機などの製造業が立地して法人関係の税収を押し上げています。つまり「大都市圏でなくても、地域の核となる都市か、稼ぐ産業を持っていれば 50% に届く」ことを、この 3 県が示しています。

裏を返せば、残り **34 県は 50% 未満**で、歳入の半分以上を国に依存しています。半分以上が国頼みというのは例外ではなく、日本の地方財政ではむしろ標準的な姿だということが、この数字から見えてきます。
...
国が税収の多い都市部から財源を吸い上げ、税収の乏しい地方に配り直す。50% 未満の 34 県は、この再分配の受け手にあたります。財政力指数の高い県と低い県の構図を合わせて見ると、この依存と再分配の関係がより立体的に理解できます。

<source-link href="/ranking/local-allocation-tax-prefecture">地方交付税（国からの再分配額）ランキングを見る</source-link>

## 30%未満の県が抱える重さ

国に半分以上を頼る 34 県のなかでも、自主財源比率が 30% を下回るのは高知県（25.7%）と鳥取県（28.3%）の 2 県だけです。この水準は、歳入のおよそ 7 割超を国に頼っていることを意味し、自前の収入だけでは行政の基礎的な運営すら成り立たない状態に近いといえます。
...
- 自主財源比率が 55% を超える県は上位 10 県のみ。「半分（50%）以上を自前で賄える」県まで広げても 13 県で、残り 34 県は国に依存する

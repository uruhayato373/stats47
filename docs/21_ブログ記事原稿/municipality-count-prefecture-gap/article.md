---
title: 市町村数はなぜ県ごとに違うのか
seoTitle: 市町村数の都道府県ランキング｜北海道179・富山15の背景
subtitle: 2024年の自治体数を、面積や人口だけで説明しないための読み方
description: 市町村数は北海道が179で最多、富山県が15で最少です。約12倍の差を生んだ地理、集落、合併の歴史を整理し、自治体数ランキングから分かることと限界を読み解きます。
...
現在の自治体数には、地形や集落の分布に加え、過去の合併や分立の経緯が刻まれています。ランキングを現在の地域特性だけで説明せず、行政区域が形成された歴史と併せて読む必要があります。
...
市町村数は自然に決まるものではなく、制度と地域の選択によって変わります。複数の市町村が合併すれば、同じ地域・人口でも自治体数は減ります。合併しなかった地域や、合併の範囲が小さかった地域では、自治体数が比較的多く残ります。

合併の判断には、行政運営の効率化、財政基盤、公共施設の配置、地域名や自治の継承などが関係します。その結果として、似た人口規模や面積を持つ県でも市町村数が違うことがあります。現在のランキングは、地理条件だけでなく、過去の政策判断を映したスナップショットでもあります。

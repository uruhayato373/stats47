...
1 位の東京都が 129,571 戸で、最下位の高知県 2,110 戸とは **61.4 倍** もの開きがあります。上位は東京・大阪・神奈川・愛知・埼玉と三大都市圏が独占し、下位は高知・鳥取・徳島・島根・秋田と人口の少ない地方県が並びます。全国合計 816,388 戸のうち上位 5 県で約 46%、千葉を加えた上位 6 県で過半（51.3%）に達します。ツリーマップでこのデータを描くと、こうした上位集中の「面積の暴力」が一目で伝わります。だからこそ「読めない小矩形は割愛する」という後述の割り切りが必要になるわけです。
...
> [!TIP]
> ツリーマップは見栄えがする一方で「絶対値の大小しか伝わらない」弱点があります。記事として読者に刺すなら、図の下に必ず「1 位と最下位で何倍差か」「上位何県で全国の何割か」といった一文の要約を添えてください。本記事なら「上位 5 都府県で全国の約 46%（上位 6 県で過半）、1 位と最下位で 61.4 倍差」が、図を見ない読者にも残る一行になります。

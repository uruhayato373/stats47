...
## 劇場・音楽堂の分布 -- 図書館とは正反対の集まり方

劇場・音楽堂等数は東京都が132施設で突出し、愛知県81施設、埼玉県76施設と続きます。下位は徳島県と鳥取県がともに13施設、高知県が14施設です。上位と下位で約10倍の開きがあります。

![劇場・音楽堂等数 上位5・下位5](data/theater-ranking.svg)

この分布を冒頭の人口あたり図書館数ランキングと比べると対照的です。人口あたり図書館数の上位は山梨・島根・長野と人口の少ない県でしたが、劇場・音楽堂は東京・愛知・埼玉と人口の多い県に集まっています。博物館数で上位だった東京・長野・北海道とも顔ぶれが違い、3つの指標で上位に重なるのは長野県だけです。

施設種別で分布が逆転する理由は、1施設あたりの規模と運営コストの差にあると考えられます。図書館は各市町村に分館を配置しやすく人口あたりの数値が伸びやすい一方、劇場・音楽堂は建設・運営コストが大きく、集客が見込める大都市に集約されやすい構造です。ただし本記事のデータには施設の規模や稼働率は含まれておらず、この説明は分布から立てた仮説にとどまります。
...
ここまで見てきた図書館数・貸出冊数・博物館数・劇場音楽堂数の4つのランキングは、いずれも「都市部が有利」という単純な図式ではなく、指標ごとに異なる県が上位に来ることを示していました。図書館数は人口の少ない県、貸出冊数は滋賀・高知、博物館数は東京・長野・北海道、劇場・音楽堂は東京・愛知・埼玉と、施設種別によって有利な地域構造が異なります。人口あたり施設数の格差は確かに存在しますが、それが直ちに住民の文化的な豊かさの格差を意味するわけではありません。自分の県がどの指標で強く、どの指標で弱いかは、各ランキングの全順位を見ると確かめられます。

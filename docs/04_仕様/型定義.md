...
## 移行スケジュール
- フェーズ1: 準備作業（1日）- [完了日: YYYY-MM-DD]
- フェーズ2: グローバル型定義の移行（2-3日）- [完了予定: YYYY-MM-DD]
- フェーズ3: ドメイン型定義の移行（2-3日）- [完了予定: YYYY-MM-DD]
...
...
### 【フェーズ3】ドメイン型定義の移行（所要時間: 2-3日）

#### ステップ3-1: e-Stat ドメインの型定義を移行する
...
### 【フェーズ4】コンポーネント型定義の整理（所要時間: 2-3日）

#### ステップ4-1: コンポーネント型定義ファイルをリネームする
...
#### ステップ4-3: index.ts に re-export を追加する
...
### 【フェーズ5】インポートパスの一括更新と検証（所要時間: 1日）

#### ステップ5-1: TypeScript コンパイラで型エラーを確認する
...
### 【フェーズ6】古いファイルの削除とクリーンアップ（所要時間: 1日）

#### ステップ6-1: 古い型定義ファイルをバックアップする
...
### 【フェーズ7】ドキュメント化と最終レビュー（所要時間: 1日）

#### ステップ7-1: 型定義ドキュメントを作成する

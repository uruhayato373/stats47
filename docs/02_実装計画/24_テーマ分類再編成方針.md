...
type: strategy
date: 2026-07-12
status: proposal-after-theme-reviews
...
- 根拠: `docs/04_レビュー/2026-07-12-theme-safety.md`
...
- 根拠: `docs/04_レビュー/2026-07-12-theme-education-culture.md`
...
実装前に`docs/01_技術設計/11_URL構造.md`を更新し、旧新URL、301、canonical、sitemap、パンくず、内部リンク、OGP、構造化データを確定する。

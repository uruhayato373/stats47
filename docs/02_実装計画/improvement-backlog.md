...
| RANK-WAVE-2026-06-12 | Tier A 15件 ランキングページ品質向上パイロット (ranking-page-quality-plan.md §4 Wave R1) — deployed 2026-06-12: 8件 seoTitle curiosity gap 改修 (dairy-cattle/retail/beef/public-phone/sushi/school-teacher/natto/konbu) + top 5 structuralInterpretation ドラフト (.claude/state/ranking/wave-r1-drafts/)。W25 残り10件 structuralInterpretation + AICONTENT-02 pipeline 待ち。GSC 計測 4 週後 W30 で +20% lift 判定 | effect/pending | 2026-07-14 | claude | gsc |
| AICONTENT-02 | DB レス準拠の ai-content 再生成パイプライン再建 — R2 values.json + correlation + metric config → Sonnet 生成 → factual gate → Opus critic → R2 push。.claude/scripts/ranking/ に配置 (AICONTENT-001 blocked の根本解消)。ranking-page-quality-plan.md §3 参照 | pending | 2026-W25 | claude (Opus) | ai-content |

...
| BLOG-WAVE-2026-06-10-manual | 是正キュー must-fix 上位 3 記事の品質是正 — deployed 2026-06-10: frozen-gyoza-spending-prefecture-gap/pachinko-participation-prefecture-gap/pharmacist-income-prefecture-gap。R2実データから data 再生成+上位5+下位5 SVG化(markdown表全廃)、である調→ですます、記事内関連削除、内部リンク補強、解釈段落補強(archetype A)。全 blog-critic PASS。GSC 計測 4 週後 | effect/pending | 2026-07-08 | claude | gsc |

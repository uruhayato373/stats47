...
> **⚠️ 2026-06-12 更新: 本書は「トラフィック施策の参考資料」に降格。**
> 収益化・チャネル・優先順位の SSOT は [`monetization-master-plan.md`](./monetization-master-plan.md)。
> 食い違う場合はそちらが優先する。本書のベースライン (25K PV/月) は GA4 過大計上を含み
> 真値は月 ~4,264 PV の可能性 (GA4-PIPELINE-02)。Phase 計画も同 SSOT のゲートに従う。

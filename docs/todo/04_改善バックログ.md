...
| PERF-WORKERS-CACHE-01 | production限定Workers Cache、HTML/RSC分離、path/data Cache-Tag、R2公開Workflowの自動purgeを実装済。**残: デプロイ後にHTML HIT・RSC no-store・warm TTFB・公開直後のpurgeを本番実測する** | in-progress | 2026-08-19 | claude | performance |

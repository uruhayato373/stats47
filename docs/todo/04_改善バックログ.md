...
|---|---|---|---|---|---|
| AFF-IMPRESSION-RENAME-01 | `affiliate_impression` が 0 件でなく vertical 別に取得できるか確認する。0件または `(not set)` の場合は GA4 登録と送信条件を再監査する | effect/pending | 2026-07-30 | claude | affiliate |
...
| AFF-CATEGORY-MAP-01 | impression計測確認後、未写像6カテゴリのうち1カテゴリだけをpilotし、AdSense減収とaffiliate成果を比較する | pending | 2026-08-15 | claude | affiliate |

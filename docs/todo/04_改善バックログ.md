...
| ADSENSE-MOBILE-INCONTENT-01 | deployed 2026-06-14。rankingモバイル本文中枠の移設効果を units/device で判定する | effect/pending | 2026-08-02 | claude | adsense |
| ADSENSE-ANCHOR-01 | deployed 2026-07-03。モバイルアンカーのみONの imp/PV・RPM・viewabilityを判定する | effect/pending | 2026-08-02 | uruhayato373 | adsense |
| ADSENSE-LAZYLOAD-01 | deployed 2026-07-03。rootMargin 600px化の imp/PV と viewability を判定する | effect/pending | 2026-08-02 | claude | adsense |
| ADSENSE-LAZYLOAD-02 | 端末別lazy-load閾値の必要性を、前施策の実測後に判断する | pending | 2026-08-09 | claude | adsense |
| ADSENSE-FOOTER-02 | deployed 2026-07-03。footer Multiplex の収益とviewabilityを判定する | effect/pending | 2026-08-02 | claude | adsense |
| ADSENSE-SLOT-DEDUPE-01 | 実装済 2026-07-05。重複slot解消後のユニット別viewabilityを判定する | effect/pending | 2026-08-02 | claude | adsense |

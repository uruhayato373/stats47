...
| `.github/workflows/sync-known-keys.yml` | `0 22 * * *` | 毎日 07:00 JST | KNOWN_*_KEYS を remote D1 から再生成、差分があれば PR 自動起票 | `apps/web/src/config/known-{ranking,tag}-keys.ts` | Phase 9 P2-A |
...
| `com.stats47.discover-trends` | 毎日 07:23 | トレンド発見バッチ | `npx claude-code -p "/discover-trends --source all"` | - |

...
│  ├── snapshots/ranking-values/<rk>/<areaType>/<year>.json  │
│  ├── snapshots/categories/, surveys/, area-profile/        │
│  ├── snapshots/correlation/by-ranking-key/<rk>.json        │
│  ├── snapshots/blog/, ai-content/, page-components/        │
│  ├── snapshots/affiliate-ads/, ports/, fishing-ports/      │
│  ├── snapshots/port-statistics/{by-year,by-port}/          │
│  ├── topojson/ (地理データ)                                │
...
| **production**  | Cloudflare R2 (snapshot JSON) | `https://storage.stats47.jp/snapshots/...` | 本番配信 (D1 binding なし) |

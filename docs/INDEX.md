...
詳細なプロジェクト説明は、[00_プロジェクト管理/01_概要/プロジェクト概要.md](./00_プロジェクト管理/01_概要/プロジェクト概要.md)を参照してください。
...
- [01_概要/](./00_プロジェクト管理/01_概要/) - プロジェクト概要・憲章
...
- [05_Storybook/](./02_デザインシステム/05_Storybook/) - Storybook
  - [Storybook運用ガイド.md](04_Storybook運用ガイド.md) - Storybook ガイド
...
- [運用/](./05_ドメイン設計/データベース/運用/) - データベース運用
  - [R2デプロイガイド.md](./05_ドメイン設計/データベース/運用/R2デプロイガイド.md) - R2デプロイガイド
  - [R2-S3セットアップ.md](./05_ドメイン設計/データベース/運用/R2-S3セットアップ.md) - R2-S3セットアップ
  - [R2保存実装.md](./05_ドメイン設計/データベース/運用/R2保存実装.md) - R2保存実装
  - [カスタムドメイン設定.md](./05_ドメイン設計/データベース/運用/カスタムドメイン設定.md) - カスタムドメイン設定
  - [開発URL設定.md](./05_ドメイン設計/データベース/運用/開発URL設定.md) - 開発URL設定
...
- [メタ情報/](./05_ドメイン設計/e-Stat API/メタ情報/) - e-Stat API メタ情報
  - [概要.md](./05_ドメイン設計/e-Stat API/メタ情報/概要.md) - メタ情報概要
  - [仕様/](./05_ドメイン設計/e-Stat API/メタ情報/仕様/) - メタ情報仕様
    - [API仕様.md](./05_ドメイン設計/e-Stat API/メタ情報/仕様/API仕様.md) - API仕様
    - [サービス仕様.md](./05_ドメイン設計/e-Stat API/メタ情報/仕様/サービス仕様.md) - サービス仕様
  - [実装/](./05_ドメイン設計/e-Stat API/メタ情報/実装/) - メタ情報実装
    - [サービス実装.md](./05_ドメイン設計/e-Stat API/メタ情報/実装/サービス実装.md) - サービス実装（Fetcher/Formatter/Batch Processor統合）
  - [テスト/](./05_ドメイン設計/e-Stat API/メタ情報/テスト/) - メタ情報テスト
    - [ユニットテスト.md](./05_ドメイン設計/e-Stat API/メタ情報/テスト/ユニットテスト.md) - ユニットテスト
...
- **コンポーネント開発**: [02_デザインシステム/02_コンポーネント設計/コンポーネント設計原則.md](02_コンポーネント設計原則.md)
- **スタイリング**: [02_デザインシステム/01_スタイルガイド/スタイルガイド.md](01_スタイルガイド.md)

...
```typescript
// src/infrastructure/geography/models/value-objects/coordinate.ts
...
```typescript
// src/infrastructure/ranking/services/domain/ranking-calculator.ts
...
```typescript
// src/infrastructure/ranking/repositories/api/ranking-repository.ts

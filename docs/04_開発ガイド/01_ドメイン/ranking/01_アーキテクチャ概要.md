...
| ----------- | -------------- | ---------- | ---------------- | ------------------------------------------------------------ |
| population  | estat          | prefecture | direct           | `{"stats_data_id":"xxx","cd_cat01":"yyy","cd_area":"00000"}` |
| population  | estat          | city       | direct           | `{"stats_data_id":"xxx","cd_cat01":"yyy","cd_area":"01000"}` |
| gdp         | estat          | prefecture | ratio            | `{"numerator":{...},"denominator":{...},"multiplier":1000}`  |
| gdp         | estat          | city       | ratio            | `{"numerator":{...},"denominator":{...},"multiplier":1000}`  |

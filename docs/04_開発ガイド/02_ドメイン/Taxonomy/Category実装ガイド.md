...
import {
  ...
  categoryById,
  sidebarCategories,
} from "@/infrastructure/taxonomy/category";
// または個別の関数をインポート
import {
  allCategories,
  categoryById,
...
```typescript
import { getNavigationCategories } from "@/infrastructure/taxonomy/category";
...
```typescript
import { normalizeCategoryData } from "@/infrastructure/taxonomy/category";
...
```typescript
import { normalizeCategoriesData } from "@/infrastructure/taxonomy/category";
...
```typescript
import { validateCategoryId } from "@/infrastructure/taxonomy/category";
...
```typescript
import { validateSubcategory } from "@/infrastructure/taxonomy/category";
...
```typescript
import { getCategoryStats } from "@/infrastructure/taxonomy/category";
...
1. **インポートエラー**
   ...
   // 修正: 正しいパスを使用
   import { allCategories, categoryById } from "@/infrastructure/taxonomy/category";
   ```
...
3. **色機能のエラー**
   ...
   import { getCategoryColorClasses } from "@/infrastructure/category/color-mapping";

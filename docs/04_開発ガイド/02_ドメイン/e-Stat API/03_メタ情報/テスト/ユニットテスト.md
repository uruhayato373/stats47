...
`src/infrastructure/estat-api/meta-info/__tests__/fetcher.test.ts`
...
`src/infrastructure/estat-api/meta-info/__tests__/formatter.test.ts`
...
`src/infrastructure/estat-api/meta-info/__tests__/batch-processor.test.ts`
...
`src/infrastructure/estat-api/meta-info/__tests__/id-utils.test.ts`
...
`src/infrastructure/estat-api/meta-info/__tests__/helpers.test.ts`
...
`src/infrastructure/estat-api/meta-info/__tests__/fixtures/index.ts`

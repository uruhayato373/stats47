...
description: "熊本市の家計は47市平均に比べ教育が1.44倍と最も高く、品目ではネクタイや婦人用ファンデーションが目立ちます。家計調査と私立大学学生数割合などの都道府県統計で背景を確かめます。"
status: published
...
熊本県の県庁所在地・熊本市の家計を、総務省「家計調査」(2024年・二人以上の世帯)で十大費目に分けて見ると、47都道府県庁所在市の単純平均を1.00としたとき、最も乖離が大きいのは教育の1.44倍です。

この記事では、十大費目の偏り、47県の中での熊本市の位置、突出した個別品目、そして教育が高くなる背景を他の都道府県統計で確かめる、という順で熊本市の家計を読み解きます。比率はすべて47市平均に対する倍率で、家計調査が公表する全国平均とは基準が異なります。
...
品目別に見ると、47市平均より多い側の上位10品目はネクタイ(3.98倍)、婦人用ファンデーション(3.83倍)、家事月謝(3.07倍)、ゲーム機(2.83倍)、私立高校(2.46倍)、航空運賃(2.45倍)、私立中学校(2.44倍)、女子用学校制服(2.34倍)、たい(2.24倍)、他の仕送り金(2.14倍)です。少ない側の10品目は教養娯楽用品修理代(0.16倍)、テーブル・ソファー(0.19倍)、バス通勤定期代(0.22倍)、ビデオレコーダー・プレイヤー(0.22倍)、鉄道通勤定期代(0.24倍)、しじみ(0.27倍)、祭具・墓石(0.28倍)、ベッド(0.28倍)、灯油(0.32倍)、被服賃借料(0.34倍)で、平均の16%程度にとどまる品目もあります。多い側の1位であるネクタイと、少ない側の1位である教養娯楽用品修理代が、熊本市の暮らしを最も端的に表す品目です。品目の倍率は世帯あたりの年間支出額を47市平均で割ったもので、購入頻度の低い品目ほど年ごとの振れが大きい点には注意が必要です。
...
本記事の数値は総務省統計局「家計調査」(2024年、二人以上の世帯)にもとづきます。都道府県の値は県全体ではなく県庁所在市である熊本市の世帯を対象にした数値で、比率の基準は47都道府県庁所在市の単純平均を1.00としたものです。裏付けに使った私立大学学生数割合と高等学校卒業者の進学率は stats47 のランキングページ(出典は各ページに記載)から取得しました。

...
- 新旧対照表を赤ペンで突き合わせ、条文の項ずれや引用切れを目視で潰している政策法務担当
- 決裁回議の後に上位法改正の反映漏れを指摘され、差し戻しで半日を失った経験のある方
- 条例の文体統一 (送り仮名・「及び / 並びに」の階層) での差し戻しを減らしたい方

**この記事でわかること**

- 改正案・現行条例・上位法・類似条例を 4 ディレクトリに集約して一括レビューする手順
- 矛盾検出 4 観点・文体統一 8 観点を `/ordinance-review` 1 コマンドに集約するスキル定義
- レビュー結果を起案文の「政策法務協議結果」欄に貼る際の、責任の所在を明記する書き方

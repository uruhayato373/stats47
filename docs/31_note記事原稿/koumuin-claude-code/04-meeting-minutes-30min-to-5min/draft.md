...
![iPhone ボイスメモアプリで録音中の画面](./images/screenshot-1-voice-memo-recording.png)
<!-- SVG: screenshot | iPhone ボイスメモアプリで録音中の画面 -->
...
<!-- SVG: screenshot | curl 実行後の transcript.json -->
...
<!-- SVG: screenshot | Claude Code で /format-minutes 実行直後の画面 -->

...
- [#01 環境構築完全版](../01-claude-code-setup-complete/draft.md) (有料 ¥300)
- [#02 庁内ネットワーク対策](../02-internal-network-workarounds/draft.md) (無料)
- [#03 IT 担当向け説明資料](../03-it-dept-security-doc/draft.md) (有料 ¥300)
...
- [#05 議会答弁 prompt 集](../05-assembly-answer-prompts/draft.md) (有料 ¥300)
- [#06 条例改正レビュー](../06-ordinance-revision-review/draft.md) (有料 ¥300)
- [#07 公用文スキル化](../07-official-doc-skills/draft.md) (有料 ¥300)
- [#08 起案文チェックリスト 20](../08-proposal-doc-checklist-20/draft.md) (有料 ¥300)
...
- [#11 Hooks による自動マスキング](../11-hooks-personal-info-masking/draft.md) (有料 ¥300)
- [#12 監査に耐える設定](../12-audit-ready-settings/draft.md) (有料 ¥300)
- [#13 Ollama でオフライン LLM](../13-ollama-offline-local-llm/draft.md) (有料 ¥300)
...
- [#26 上司への説明資料](../26-boss-approval-deck/draft.md) (有料 ¥300) ほか #27-#30
...
3. [#01 環境構築完全版](../01-claude-code-setup-complete/draft.md) (有料 ¥300) — 実際に動かしたい人向け
4. [#05 議会答弁 prompt 集](../05-assembly-answer-prompts/draft.md) (有料 ¥300) — 議会事務局・政策担当向け
...
→ [#26 上司への説明資料](../26-boss-approval-deck/draft.md) (有料 ¥300)
